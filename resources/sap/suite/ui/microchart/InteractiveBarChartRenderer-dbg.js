...
sap.ui.define([],
	...
	*/
	...
	InteractiveBarChartRenderer.render = function(oRm, oControl) {
		...
		var iBarsNum, aBars;
		iBarsNum = oControl.getDisplayedBars();
		aBars = oControl.getAggregation("bars");
		if (iBarsNum > aBars.length) {
			iBarsNum = aBars.length;
		}
	...
	InteractiveBarChartRenderer._renderBarDirection = function(oRm, oControl, bar, barIndex, displayValue, barDirection) {
		...
		oRm.writeClasses();
		if (bar._bNullValue || bar.getValue() === 0) {
