...
sap.ui.define(['jquery.sap.global', './library', 'sap/ui/core/Control', 'sap/m/Size'],
	...
	BulletMicroChart.prototype._calculateChartData = function() {
		...
		return {
			actualValuePct: (!this.getActual() || !this.getActual()._isValueSet || fTotal == 0 || this.getActual().getValue() === 0) ? 0 : (0.05 + (fActual - fLowestValue) * fScaleWidthPct / fTotal).toFixed(2),
