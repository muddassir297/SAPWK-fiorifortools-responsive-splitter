...
sap.ui.define(["jquery.sap.global", "sap/ui/Device"],
	...
	*/
	...
	RadialMicroChartRenderer._writeSVGStartElement = function(control, oRm) {
		...
		var sSizeClass = "sapSuiteRMCSize" + control.getSize();
		oRm.write("<svg class=\"sapSuiteRMC " + jQuery.sap.encodeHTML(sSizeClass) + "\" viewBox=\"0 0 " + RadialMicroChartRenderer.FORM_RATIO + ' ' + RadialMicroChartRenderer.FORM_RATIO + "\" preserveAspectRatio=\"" + jQuery.sap.encodeHTML(sPreserveAspectRatio) + "\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\">");
	};
	...
	RadialMicroChartRenderer._handleOnAfterRendering = function(control) {
		...
		} else if (control.getSize() === "Responsive") {
