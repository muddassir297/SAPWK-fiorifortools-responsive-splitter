 ...
 * 	
 */
jQuery.sap.declare("sap.suite.ui.commons.LinkActionSheet");jQuery.sap.require("sap.suite.ui.commons.library");jQuery.sap.require("sap.m.ActionSheet");sap.m.ActionSheet.extend("sap.suite.ui.commons.LinkActionSheet",{metadata:{deprecated:true,library:"sap.suite.ui.commons",aggregations:{"items":{type:"sap.ui.core.Control",multiple:true,singularName:"item"}},events:{"itemPress":{allowPreventDefault:true,parameters:{"item":{type:"sap.ui.core.Control"}}}}}});sap.suite.ui.commons.LinkActionSheet.M_EVENTS={'itemPress':'itemPress'};
