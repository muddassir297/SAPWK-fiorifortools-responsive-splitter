...
/**
 * Initialization Code and shared classes of library sap.suite.ui.commons (1.46.0)
 */
...
sap.ui.getCore().initLibrary({
	name : "sap.suite.ui.commons",
	dependencies : ["sap.ui.core","sap.suite.ui.microchart","sap.m"],
	types: [
...
// Provides enumeration sap.suite.ui.commons.ProcessFlowConnectionLabelState.
jQuery.sap.declare("sap.suite.ui.commons.ProcessFlowConnectionLabelState");
/**
 * @class Describes the state of a connection label.
 *
 * @version 1.46.0
 * @static
 * @public
...
// Provides enumeration sap.suite.ui.commons.ProcessFlowConnectionState.
jQuery.sap.declare("sap.suite.ui.commons.ProcessFlowConnectionState");
/**
 * @class Describes the state of a connection.
 *
 * @version 1.46.0
 * @static
 * @public
...
// Provides enumeration sap.suite.ui.commons.ProcessFlowConnectionType.
jQuery.sap.declare("sap.suite.ui.commons.ProcessFlowConnectionType");
/**
 * @class Describes the type of a connection.
 *
 * @version 1.46.0
 * @static
 * @public
...
/**
 * @class Describes the state connected to the content it is representing in the Process Flow Node. The state is also displayed in the Process Flow Lane Header as a color segment of the donut.
 *
 * @version 1.46.0
 * @static
 * @public
...
// Provides enumeration sap.suite.ui.commons.ProcessFlowNodeType.
jQuery.sap.declare("sap.suite.ui.commons.ProcessFlowNodeType");
/**
 * @class Describes the type of a node. The type value could be single or aggregated. With this type,
...
/**
 * @class The alignment of timeline posts relative to the timeline axis.
 *
 * @version 1.46.0
 * @static
 * @public
...
/**
 * @class Defines the orientation of the timeline axis.
 *
 * @version 1.46.0
 * @static
 * @public
...
// Provides enumeration sap.suite.ui.commons.TimelineFilterType.
jQuery.sap.declare("sap.suite.ui.commons.TimelineFilterType");
/**
 * @class Filter type for the timeline.
 *
 * @version 1.46.0
 * @static
 * @public
...
// Provides enumeration sap.suite.ui.commons.TimelineGroupType.
jQuery.sap.declare("sap.suite.ui.commons.TimelineGroupType");
/**
 * @class Type of grouping for timeline entries.
 *
 * @version 1.46.0
 * @static
 * @public
...
// Provides enumeration sap.suite.ui.commons.TimelineScrollingFadeout.
jQuery.sap.declare("sap.suite.ui.commons.TimelineScrollingFadeout");
/**
 * @class Type of the fadeout effect applied to the upper and lower margins of the visible timeline area.
 *
 * @version 1.46.0
 * @static
 * @public
