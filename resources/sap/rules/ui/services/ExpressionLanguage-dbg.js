...
sap.ui.define(["jquery.sap.global",
	...
	function (jQuery, Element, ParsingBackendMediator, RuleServices, resourcesConvertor, RtsInitiator, responseCollector, Locale, LocaleData) {
        ...
        ExpressionLanguage.prototype._setDataFromModel = function () {
			if (this.hasModel() && this.getBindingContextPath()){
				this.getModel().read(this.getBindingContextPath(), {
					urlParameters: {
						"$expand": "DataObjects/Associations,DataObjects/Attributes,ValueHelps"
					},
		...
		ExpressionLanguage.prototype.convertDecisionTableExpressionToModelValue = function (sHeaderExpression, sFixedOpr, sCellExpression,
			...
			var response = this._validateDecisionTableExpression(sHeaderExpression, sFixedOpr, sCellExpression, eExpressionType, flags, "RuleServiceValidation");
			return response;
		  };



		ExpressionLanguage.prototype._validateDecisionTableExpression = function (sHeaderExpression, sFixedOpr, sCellExpression,eExpressionType, flags, sResponseCollectorStatus){
			...
			var result = RuleServices.lib.validateDecisionTableExpression(sHeaderExpression, sFixedOpr, sCellExpression, eExpressionType, this._vocabularyName,this._runtimeService, null, flags);
