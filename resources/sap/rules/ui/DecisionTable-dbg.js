...
sap.ui.define([
	...
	Link, Label, BusyIndicator, DisplayListItem, MenuItem, FlexBox, MessageStrip, DecisionTableHeaderFormatter, DecisionTableSettingsOld) {
	"use strict";
...
/*			if (value === true) {
		...
		isSequenceExistsInOdataMetadata: function() {
			...
			for (var i = 0; i < aEntities.length; i++){
				...
				if (entity.entityType !== "RULE_SRV.DecisionTableColumn"){
					continue;
				}
