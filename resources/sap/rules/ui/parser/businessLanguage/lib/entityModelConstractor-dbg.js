...
sap.rules.ui.parser.businessLanguage.lib.entityModelConstractor.lib = (function() {
	...
	function NavigationPredicateDetails(args) { // args : {navigationPredicate, attribute, rootObject, associationsArray}
		try {
			...
			utilsLib.addProperties(this, args, ["navigationPredicate", "navigationFullPath", "attribute", "attributeType", "rootObject", "associationsArray", "attributeMappingType", "attributeValueList", "isParameter", "isCollection", "isAlias", "isDataObject", "dataObject", "modifiers"], [null, null, null, null, null, null, null, null, false, false, false, null, null, null]);
