...
// $ANTLR 3.3 Nov 30, 2010 12:45:30 IDP.g 2017-01-04 18:20:28
...
org.antlr.lang.augmentObject(IDPLexer.prototype, {
    ...
    mFILTER_BY: function()  {
       ...
       try {
            // IDP.g:709:17: ( FILTER ( WS )+ BY )
            // IDP.g:709:33: FILTER ( WS )+ BY
            this.mFILTER(); 
            // IDP.g:709:40: ( WS )+
            var cnt1=0;
            loop1:
    ...
    mGROUP_BY: function()  {
       ...
       try {
            // IDP.g:727:17: ( GROUPED ( WS )+ BY )
            // IDP.g:727:33: GROUPED ( WS )+ BY
            this.mGROUPED(); 
            // IDP.g:727:41: ( WS )+
            var cnt2=0;
            loop2:
    ...
    mCOUNT_DISTINCT_OF: function()  {
       ...
       try {
            // IDP.g:734:17: ( COUNT ( WS )+ DISTINCT ( WS )+ OF )
            // IDP.g:734:33: COUNT ( WS )+ DISTINCT ( WS )+ OF
            this.mCOUNT(); 
            // IDP.g:734:39: ( WS )+
            var cnt3=0;
            loop3:
    ...
    mCOUNT_OF: function()  {
       ...
       try {
            // IDP.g:737:17: ( COUNT ( WS )+ OF )
            // IDP.g:737:33: COUNT ( WS )+ OF
            this.mCOUNT(); 
            // IDP.g:737:39: ( WS )+
            var cnt5=0;
            loop5:
    ...
    mCOUNTD_OF: function()  {
       ...
       try {
            // IDP.g:740:17: ( COUNTD ( WS )+ OF )
            // IDP.g:740:33: COUNTD ( WS )+ OF
            this.mCOUNTD(); 
            // IDP.g:740:40: ( WS )+
            var cnt6=0;
            loop6:
    ...
    mANY_OF: function()  {
       ...
       try {
            // IDP.g:830:17: ( ANY ( WS )+ OF ( WS )+ THE ( WS )+ FOLLOWING ( WS )+ CONDITIONS ( WS )+ IS ( WS )+ T R U E COLON )
            // IDP.g:830:33: ANY ( WS )+ OF ( WS )+ THE ( WS )+ FOLLOWING ( WS )+ CONDITIONS ( WS )+ IS ( WS )+ T R U E COLON
            this.mANY(); 
            // IDP.g:830:37: ( WS )+
            var cnt7=0;
            loop7:
    ...
    mALL_OF: function()  {
       ...
       try {
            // IDP.g:833:17: ( FALL FWS OF ( WS )+ THE ( WS )+ FOLLOWING ( WS )+ CONDITIONS ( WS )+ ARE ( WS )+ T R U E COLON )
            // IDP.g:833:33: FALL FWS OF ( WS )+ THE ( WS )+ FOLLOWING ( WS )+ CONDITIONS ( WS )+ ARE ( WS )+ T R U E COLON
            this.mFALL(); 
            this.mFWS(); 
            this.mOF(); 
            // IDP.g:833:45: ( WS )+
    ...
    mIS_EQUAL: function()  {
       ...
       try {
            // IDP.g:1160:17: ( IS ( WS )+ EQUAL ( WS )+ TO )
            // IDP.g:1160:33: IS ( WS )+ EQUAL ( WS )+ TO
            this.mIS(); 
            // IDP.g:1160:36: ( WS )+
            var cnt18=0;
            loop18:
    ...
    mDOES_NOT_EQUAL: function()  {
       ...
       try {
            // IDP.g:1162:17: ( DOES ( WS )+ NOT ( WS )+ EQUAL )
            // IDP.g:1162:33: DOES ( WS )+ NOT ( WS )+ EQUAL
            this.mDOES(); 
            // IDP.g:1162:38: ( WS )+
            var cnt20=0;
            loop20:
    ...
    mIS_NOT_EQUAL: function()  {
       ...
       try {
            // IDP.g:1164:17: ( IS ( WS )+ NOT ( WS )+ EQUAL ( WS )+ TO )
            // IDP.g:1164:33: IS ( WS )+ NOT ( WS )+ EQUAL ( WS )+ TO
            this.mIS(); 
            // IDP.g:1164:36: ( WS )+
            var cnt22=0;
            loop22:
    ...
    mNOT_EQUAL: function()  {
       ...
       try {
            // IDP.g:1166:17: ( NOT ( WS )+ EQUALS )
            // IDP.g:1166:33: NOT ( WS )+ EQUALS
            this.mNOT(); 
            // IDP.g:1166:37: ( WS )+
            var cnt25=0;
            loop25:
    ...
    mIS_ONE_OF: function()  {
       ...
       try {
            // IDP.g:1215:17: ( IS ( WS )+ ONE ( WS )+ OF )
            // IDP.g:1215:33: IS ( WS )+ ONE ( WS )+ OF
            this.mIS(); 
            // IDP.g:1215:36: ( WS )+
            var cnt26=0;
            loop26:
    ...
    mIS_NOT_ONE_OF: function()  {
       ...
       try {
            // IDP.g:1217:17: ( IS ( WS )+ NOT ( WS )+ ONE ( WS )+ OF )
            // IDP.g:1217:33: IS ( WS )+ NOT ( WS )+ ONE ( WS )+ OF
            this.mIS(); 
            // IDP.g:1217:36: ( WS )+
            var cnt28=0;
            loop28:
    ...
    mEXISTS_IN: function()  {
       ...
       try {
            // IDP.g:1219:17: ( EXISTS ( WS )+ IN )
            // IDP.g:1219:33: EXISTS ( WS )+ IN
            this.mEXISTS(); 
            // IDP.g:1219:40: ( WS )+
            var cnt31=0;
            loop31:
    ...
    mDOES_NOT_EXISTS_IN: function()  {
       ...
       try {
            // IDP.g:1223:17: ( DOES ( WS )+ NOT ( WS )+ EXIST ( WS )+ IN )
            // IDP.g:1223:33: DOES ( WS )+ NOT ( WS )+ EXIST ( WS )+ IN
            this.mDOES(); 
            // IDP.g:1223:38: ( WS )+
            var cnt32=0;
            loop32:
    ...
    mIS_LESS_THAN: function()  {
       ...
       try {
            // IDP.g:1902:17: ( IS ( WS )+ LESS ( WS )+ THAN )
            // IDP.g:1902:33: IS ( WS )+ LESS ( WS )+ THAN
            this.mIS(); 
            // IDP.g:1902:36: ( WS )+
            var cnt35=0;
            loop35:
    ...
    mLESS_THAN: function()  {
       ...
       try {
            // IDP.g:1904:17: ( LESS ( WS )+ THAN )
            // IDP.g:1904:33: LESS ( WS )+ THAN
            this.mLESS(); 
            // IDP.g:1904:38: ( WS )+
            var cnt37=0;
            loop37:
    ...
    mIS_GREATER_THAN: function()  {
       ...
       try {
            // IDP.g:1906:17: ( IS ( WS )+ GREATER ( WS )+ THAN )
            // IDP.g:1906:33: IS ( WS )+ GREATER ( WS )+ THAN
            this.mIS(); 
            // IDP.g:1906:36: ( WS )+
            var cnt38=0;
            loop38:
    ...
    mGREATER_THAN: function()  {
       ...
       try {
            // IDP.g:1908:17: ( GREATER ( WS )+ THAN )
            // IDP.g:1908:33: GREATER ( WS )+ THAN
            this.mGREATER(); 
            // IDP.g:1908:41: ( WS )+
            var cnt40=0;
            loop40:
    ...
    mIS_NOT_LESS_THAN: function()  {
       ...
       try {
            // IDP.g:1910:17: ( IS ( WS )+ NOT ( WS )+ LESS ( WS )+ THAN )
            // IDP.g:1910:33: IS ( WS )+ NOT ( WS )+ LESS ( WS )+ THAN
            this.mIS(); 
            // IDP.g:1910:36: ( WS )+
            var cnt41=0;
            loop41:
    ...
    mIS_NOT_GREATER_THAN: function()  {
       ...
       try {
            // IDP.g:1912:17: ( IS ( WS )+ NOT ( WS )+ GREATER ( WS )+ THAN )
            // IDP.g:1912:33: IS ( WS )+ NOT ( WS )+ GREATER ( WS )+ THAN
            this.mIS(); 
            // IDP.g:1912:36: ( WS )+
            var cnt44=0;
            loop44:
    ...
    mIS_EQUAL_OR_LESS_THAN: function()  {
       ...
       try {
            // IDP.g:1914:17: ( IS ( WS )+ EQUAL ( WS )+ OR ( WS )+ LESS ( WS )+ THAN )
            // IDP.g:1914:33: IS ( WS )+ EQUAL ( WS )+ OR ( WS )+ LESS ( WS )+ THAN
            this.mIS(); 
            // IDP.g:1914:36: ( WS )+
            var cnt47=0;
            loop47:
    ...
    mIS_EQUAL_OR_GREATER_THAN: function()  {
       ...
       try {
            // IDP.g:1916:17: ( IS ( WS )+ EQUAL ( WS )+ OR ( WS )+ GREATER ( WS )+ THAN )
            // IDP.g:1916:33: IS ( WS )+ EQUAL ( WS )+ OR ( WS )+ GREATER ( WS )+ THAN
            this.mIS(); 
            // IDP.g:1916:36: ( WS )+
            var cnt51=0;
            loop51:
    ...
    mIS_IN_THE_LAST: function()  {
       ...
       try {
            // IDP.g:1938:17: ( IS ( WS )+ IN ( WS )+ THE ( WS )+ LAST )
            // IDP.g:1938:33: IS ( WS )+ IN ( WS )+ THE ( WS )+ LAST
            this.mIS(); 
            // IDP.g:1938:36: ( WS )+
            var cnt55=0;
            loop55:
    ...
    mIS_NOT_IN_THE_LAST: function()  {
       ...
       try {
            // IDP.g:1940:17: ( IS ( WS )+ NOT ( WS )+ IN ( WS )+ THE ( WS )+ LAST )
            // IDP.g:1940:33: IS ( WS )+ NOT ( WS )+ IN ( WS )+ THE ( WS )+ LAST
            this.mIS(); 
            // IDP.g:1940:36: ( WS )+
            var cnt58=0;
            loop58:
    ...
    mIS_IN_THE_NEXT: function()  {
       ...
       try {
            // IDP.g:1943:17: ( IS ( WS )+ IN ( WS )+ THE ( WS )+ NEXT )
            // IDP.g:1943:33: IS ( WS )+ IN ( WS )+ THE ( WS )+ NEXT
            this.mIS(); 
            // IDP.g:1943:36: ( WS )+
            var cnt62=0;
            loop62:
    ...
    mIS_NOT_IN_THE_NEXT: function()  {
       ...
       try {
            // IDP.g:1945:17: ( IS ( WS )+ NOT ( WS )+ IN ( WS )+ THE ( WS )+ NEXT )
            // IDP.g:1945:33: IS ( WS )+ NOT ( WS )+ IN ( WS )+ THE ( WS )+ NEXT
            this.mIS(); 
            // IDP.g:1945:36: ( WS )+
            var cnt65=0;
            loop65:
    ...
    mIS_BEFORE: function()  {
       ...
       try {
            // IDP.g:1954:17: ( IS ( WS )+ BEFORE )
            // IDP.g:1954:33: IS ( WS )+ BEFORE
            this.mIS(); 
            // IDP.g:1954:36: ( WS )+
            var cnt69=0;
            loop69:
    ...
    mIS_AFTER: function()  {
       ...
       try {
            // IDP.g:1956:17: ( IS ( WS )+ AFTER )
            // IDP.g:1956:33: IS ( WS )+ AFTER
            this.mIS(); 
            // IDP.g:1956:36: ( WS )+
            var cnt70=0;
            loop70:
    ...
    mIS_NOT_BEFORE: function()  {
       ...
       try {
            // IDP.g:1958:17: ( IS ( WS )+ NOT ( WS )+ BEFORE )
            // IDP.g:1958:33: IS ( WS )+ NOT ( WS )+ BEFORE
            this.mIS(); 
            // IDP.g:1958:36: ( WS )+
            var cnt71=0;
            loop71:
    ...
    mIS_NOT_AFTER: function()  {
       ...
       try {
            // IDP.g:1960:17: ( IS ( WS )+ NOT ( WS )+ AFTER )
            // IDP.g:1960:33: IS ( WS )+ NOT ( WS )+ AFTER
            this.mIS(); 
            // IDP.g:1960:36: ( WS )+
            var cnt73=0;
            loop73:
    ...
    mIS_BETWEEN: function()  {
       ...
       try {
            // IDP.g:1969:17: ( IS ( WS )+ BETWEEN )
            // IDP.g:1969:33: IS ( WS )+ BETWEEN
            this.mIS(); 
            // IDP.g:1969:36: ( WS )+
            var cnt75=0;
            loop75:
    ...
    mIS_NOT_BETWEEN: function()  {
       ...
       try {
            // IDP.g:1971:17: ( IS ( WS )+ NOT ( WS )+ BETWEEN )
            // IDP.g:1971:33: IS ( WS )+ NOT ( WS )+ BETWEEN
            this.mIS(); 
            // IDP.g:1971:36: ( WS )+
            var cnt76=0;
            loop76:
    ...
    mIS_LIKE: function()  {
       ...
       try {
            // IDP.g:2341:17: ( IS ( WS )+ LIKE )
            // IDP.g:2341:33: IS ( WS )+ LIKE
            this.mIS(); 
            // IDP.g:2341:36: ( WS )+
            var cnt78=0;
            loop78:
    ...
    mIS_NOT_LIKE: function()  {
       ...
       try {
            // IDP.g:2343:17: ( IS ( WS )+ NOT ( WS )+ LIKE )
            // IDP.g:2343:33: IS ( WS )+ NOT ( WS )+ LIKE
            this.mIS(); 
            // IDP.g:2343:36: ( WS )+
            var cnt79=0;
            loop79:
    ...
    mNOT_LIKE: function()  {
       ...
       try {
            // IDP.g:2345:17: ( NOT ( WS )* LIKE )
            // IDP.g:2345:33: NOT ( WS )* LIKE
            this.mNOT(); 
            // IDP.g:2345:37: ( WS )*
            loop81:
            do {
    ...
    mNOT_IN: function()  {
       ...
       try {
            // IDP.g:2352:17: ( NOT ( WS )+ IN )
            // IDP.g:2352:33: NOT ( WS )+ IN
            this.mNOT(); 
            // IDP.g:2352:37: ( WS )+
            var cnt82=0;
            loop82:
    ...
    mDOES_NOT_CONTAIN: function()  {
       ...
       try {
            // IDP.g:2355:17: ( DOES ( FWS )+ NOT ( FWS )+ CONTAIN )
            // IDP.g:2355:33: DOES ( FWS )+ NOT ( FWS )+ CONTAIN
            this.mDOES(); 
            // IDP.g:2355:38: ( FWS )+
            var cnt83=0;
            loop83:
    ...
    mDOES_NOT_START: function()  {
       ...
       try {
            // IDP.g:2364:17: ( DOES ( WS )+ NOT ( WS )+ START ( WS )+ WITH )
            // IDP.g:2364:33: DOES ( WS )+ NOT ( WS )+ START ( WS )+ WITH
            this.mDOES(); 
            // IDP.g:2364:38: ( WS )+
            var cnt85=0;
            loop85:
    ...
    mSTART_WITH: function()  {
       ...
       try {
            // IDP.g:2370:17: ( STARTS ( WS )+ WITH )
            // IDP.g:2370:33: STARTS ( WS )+ WITH
            this.mSTARTS(); 
            // IDP.g:2370:40: ( WS )+
            var cnt88=0;
            loop88:
    ...
    mDOES_NOT_END: function()  {
       ...
       try {
            // IDP.g:2372:17: ( DOES ( WS )+ NOT ( WS )+ END ( WS )+ WITH )
            // IDP.g:2372:33: DOES ( WS )+ NOT ( WS )+ END ( WS )+ WITH
            this.mDOES(); 
            // IDP.g:2372:38: ( WS )+
            var cnt89=0;
            loop89:
    ...
    mEND_WITH: function()  {
       ...
       try {
            // IDP.g:2378:17: ( ENDS ( WS )+ WITH )
            // IDP.g:2378:33: ENDS ( WS )+ WITH
            this.mENDS(); 
            // IDP.g:2378:38: ( WS )+
            var cnt92=0;
            loop92:
    ...
    mAVERAGE_OF: function()  {
       ...
       try {
            // IDP.g:2634:14: ( AVERAGE ( WS )+ OF )
            // IDP.g:2634:30: AVERAGE ( WS )+ OF
            this.mAVERAGE(); 
            // IDP.g:2634:38: ( WS )+
            var cnt93=0;
            loop93:
    ...
    mSUM_OF: function()  {
       ...
       try {
            // IDP.g:2635:29: ( SUM ( WS )+ OF )
            // IDP.g:2635:45: SUM ( WS )+ OF
            this.mSUM(); 
            // IDP.g:2635:49: ( WS )+
            var cnt94=0;
            loop94:
    ...
    mMAXIMUM_OF: function()  {
       ...
       try {
            // IDP.g:2637:23: ( MAXIMUM ( WS )+ OF )
            // IDP.g:2637:39: MAXIMUM ( WS )+ OF
            this.mMAXIMUM(); 
            // IDP.g:2637:47: ( WS )+
            var cnt95=0;
            loop95:
    ...
    mMOST_RECENT: function()  {
       ...
       try {
            // IDP.g:2639:13: ( MOST ( WS )+ RECENT )
            // IDP.g:2639:29: MOST ( WS )+ RECENT
            this.mMOST(); 
            // IDP.g:2639:34: ( WS )+
            var cnt96=0;
            loop96:
    ...
    mMINIMUM_OF: function()  {
       ...
       try {
            // IDP.g:2641:12: ( MINIMUM ( WS )+ OF )
            // IDP.g:2641:28: MINIMUM ( WS )+ OF
            this.mMINIMUM(); 
            // IDP.g:2641:36: ( WS )+
            var cnt97=0;
            loop97:
    ...
    mHIGHEST: function()  {
       ...
       try {
            // IDP.g:3153:31: ( H I G H E S T )
            // IDP.g:3153:43: H I G H E S T
            this.mH(); 
            this.mI(); 
            this.mG(); 
            this.mH(); 
    ...
    mLOWEST: function()  {
       ...
       try {
            // IDP.g:3154:31: ( L O W E S T )
            // IDP.g:3154:43: L O W E S T
            this.mL(); 
            this.mO(); 
            this.mW(); 
            this.mE(); 
    ...
    mSORTED: function()  {
        try {
            // IDP.g:3155:37: ( S O R T E D )
            // IDP.g:3155:49: S O R T E D
            this.mS(); 
            this.mO(); 
            this.mR(); 
            this.mT(); 
    ...
    mRECENT: function()  {
        try {
            // IDP.g:3156:37: ( R E C E N T )
            // IDP.g:3156:49: R E C E N T
            this.mR(); 
            this.mE(); 
            this.mC(); 
            this.mE(); 
    ...
    mMOST: function()  {
        try {
            // IDP.g:3157:38: ( M O S T )
            // IDP.g:3157:50: M O S T
            this.mM(); 
            this.mO(); 
            this.mS(); 
            this.mT(); 
    ...
    mOCCURRENCES: function()  {
        try {
            // IDP.g:3158:22: ( O C C U R R E N C E S )
            // IDP.g:3158:25: O C C U R R E N C E S
            this.mO(); 
            this.mC(); 
            this.mC(); 
            this.mU(); 
    ...
    mPATTERN: function()  {
       ...
       try {
            // IDP.g:3159:9: ( P A T T E R N )
            // IDP.g:3159:11: P A T T E R N
            this.mP(); 
            this.mA(); 
            this.mT(); 
            this.mT(); 
    ...
    mEARLIEST: function()  {
       ...
       try {
            // IDP.g:3162:20: ( E A R L I E S T )
            // IDP.g:3162:32: E A R L I E S T
            this.mE(); 
            this.mA(); 
            this.mR(); 
            this.mL(); 
    ...
    mFROM: function()  {
        try {
            // IDP.g:3163:38: ( F R O M )
            // IDP.g:3163:50: F R O M
            this.mF(); 
            this.mR(); 
            this.mO(); 
            this.mM(); 
    ...
    mWITH_THE_MOST_RECENT: function()  {
       ...
       try {
            // IDP.g:3166:25: ( WITH ( WS )+ THE ( WS )+ MOST ( WS )+ RECENT )
            // IDP.g:3166:37: WITH ( WS )+ THE ( WS )+ MOST ( WS )+ RECENT
            this.mWITH(); 
            // IDP.g:3166:42: ( WS )+
            var cnt98=0;
            loop98:
    ...
    mWITH_THE_EARLIEST: function()  {
       ...
       try {
            // IDP.g:3168:25: ( WITH ( WS )+ THE ( WS )+ EARLIEST )
            // IDP.g:3168:37: WITH ( WS )+ THE ( WS )+ EARLIEST
            this.mWITH(); 
            // IDP.g:3168:42: ( WS )+
            var cnt101=0;
            loop101:
    ...
    mSORTED_FROM_A_TO_Z_BY: function()  {
       ...
       try {
            // IDP.g:3170:25: ( SORTED ( WS )+ FROM ( WS )+ A ( WS )+ TO ( WS )+ Z ( WS )+ BY )
            // IDP.g:3170:37: SORTED ( WS )+ FROM ( WS )+ A ( WS )+ TO ( WS )+ Z ( WS )+ BY
            this.mSORTED(); 
            // IDP.g:3170:44: ( WS )+
            var cnt103=0;
            loop103:
    ...
    mSORTED_FROM_Z_TO_A_BY: function()  {
       ...
       try {
            // IDP.g:3172:25: ( SORTED ( WS )+ FROM ( WS )+ Z ( WS )+ TO ( WS )+ A ( WS )+ BY )
            // IDP.g:3172:37: SORTED ( WS )+ FROM ( WS )+ Z ( WS )+ TO ( WS )+ A ( WS )+ BY
            this.mSORTED(); 
            // IDP.g:3172:44: ( WS )+
            var cnt108=0;
            loop108:
    ...
    mWITH_THE_HIGHEST: function()  {
       ...
       try {
            // IDP.g:3174:25: ( WITH ( WS )+ THE ( WS )+ HIGHEST )
            // IDP.g:3174:37: WITH ( WS )+ THE ( WS )+ HIGHEST
            this.mWITH(); 
            // IDP.g:3174:42: ( WS )+
            var cnt113=0;
            loop113:
    ...
    mWITH_THE_LOWEST: function()  {
       ...
       try {
            // IDP.g:3176:25: ( WITH ( WS )+ THE ( WS )+ LOWEST )
            // IDP.g:3176:37: WITH ( WS )+ THE ( WS )+ LOWEST
            this.mWITH(); 
            // IDP.g:3176:42: ( WS )+
            var cnt115=0;
            loop115:
    ...
    mNUMBER_OF: function()  {
       ...
       try {
            // IDP.g:3179:25: ( NUMBER ( FWS )+ FOF )
            // IDP.g:3179:37: NUMBER ( FWS )+ FOF
            this.mNUMBER(); 
            // IDP.g:3179:44: ( FWS )+
            var cnt117=0;
            loop117:
    ...
    mOCCURENCES_REGEXP: function()  {
       ...
       try {
            // IDP.g:3181:23: ( OCCURRENCES ( WS )+ C O N T A I N I N G ( WS )+ PATTERN )
            // IDP.g:3181:35: OCCURRENCES ( WS )+ C O N T A I N I N G ( WS )+ PATTERN
            this.mOCCURRENCES(); 
            // IDP.g:3181:47: ( WS )+
            var cnt118=0;
            loop118:
    ...
    mFOLLOWING: function()  {
        try {
            // IDP.g:3186:22: ( F O L L O W I N G )
            // IDP.g:3186:28: F O L L O W I N G
            this.mF(); 
            this.mO(); 
            this.mL(); 
            this.mL(); 
    ...
    mCONDITIONS: function()  {
        try {
            // IDP.g:3187:23: ( C O N D I T I O N S )
            // IDP.g:3187:25: C O N D I T I O N S
            this.mC(); 
            this.mO(); 
            this.mN(); 
            this.mD(); 
    ...
    mLINE: function()  {
        try {
            // IDP.g:3190:15: ( L I N E )
            // IDP.g:3190:27: L I N E
            this.mL(); 
            this.mI(); 
            this.mN(); 
            this.mE(); 
    ...
    mLIST: function()  {
        try {
            // IDP.g:3192:15: ( L I S T )
            // IDP.g:3192:27: L I S T
            this.mL(); 
            this.mI(); 
            this.mS(); 
            this.mT(); 
    ...
    mNUMBER: function()  {
        try {
            // IDP.g:3194:23: ( N U M B E R )
            // IDP.g:3194:35: N U M B E R
            this.mN(); 
            this.mU(); 
            this.mM(); 
            this.mB(); 
    ...
    mUNIQUE: function()  {
        try {
            // IDP.g:3195:24: ( U N I Q U E )
            // IDP.g:3195:36: U N I Q U E
            this.mU(); 
            this.mN(); 
            this.mI(); 
            this.mQ(); 
    ...
    mFUZZY: function()  {
        try {
            // IDP.g:3197:16: ( F U Z Z Y )
            // IDP.g:3197:19: F U Z Z Y
            this.mF(); 
            this.mU(); 
            this.mZ(); 
            this.mZ(); 
    ...
    mSCORE: function()  {
        try {
            // IDP.g:3198:16: ( S C O R E )
            // IDP.g:3198:18: S C O R E
            this.mS(); 
            this.mC(); 
            this.mO(); 
            this.mR(); 
    ...
    mCONCATENATE: function()  {
       ...
       try {
            // IDP.g:3200:13: ( C O N C A T E N A T E )
            // IDP.g:3200:29: C O N C A T E N A T E
            this.mC(); 
            this.mO(); 
            this.mN(); 
            this.mC(); 
    ...
    mROUND: function()  {
       ...
       try {
            // IDP.g:3201:7: ( R O U N D )
            // IDP.g:3201:29: R O U N D
            this.mR(); 
            this.mO(); 
            this.mU(); 
            this.mN(); 
    ...
    mPOWER: function()  {
       ...
       try {
            // IDP.g:3202:7: ( P O W E R )
            // IDP.g:3202:29: P O W E R
            this.mP(); 
            this.mO(); 
            this.mW(); 
            this.mE(); 
    ...
    mCURRENT: function()  {
       ...
       try {
            // IDP.g:3206:37: ( C U R R E N T )
            // IDP.g:3206:53: C U R R E N T
            this.mC(); 
            this.mU(); 
            this.mR(); 
            this.mR(); 
    ...
    mNULL: function()  {
       ...
       try {
            // IDP.g:3207:26: ( N U L L )
            // IDP.g:3207:42: N U L L
            this.mN(); 
            this.mU(); 
            this.mL(); 
            this.mL(); 
    ...
    mMINIMUM: function()  {
       ...
       try {
            // IDP.g:3217:21: ( M I N I M U M )
            // IDP.g:3217:33: M I N I M U M
            this.mM(); 
            this.mI(); 
            this.mN(); 
            this.mI(); 
    ...
    mMAXIMUM: function()  {
       ...
       try {
            // IDP.g:3218:21: ( M A X I M U M )
            // IDP.g:3218:33: M A X I M U M
            this.mM(); 
            this.mA(); 
            this.mX(); 
            this.mI(); 
    ...
    mAVERAGE: function()  {
       ...
       try {
            // IDP.g:3220:17: ( A V E R A G E )
            // IDP.g:3220:29: A V E R A G E
            this.mA(); 
            this.mV(); 
            this.mE(); 
            this.mR(); 
    ...
    mLAST: function()  {
       ...
       try {
            // IDP.g:3221:10: ( L A S T )
            // IDP.g:3221:22: L A S T
            this.mL(); 
            this.mA(); 
            this.mS(); 
            this.mT(); 
    ...
    mFIRST: function()  {
       ...
       try {
            // IDP.g:3222:10: ( F I R S T )
            // IDP.g:3222:22: F I R S T
            this.mF(); 
            this.mI(); 
            this.mR(); 
            this.mS(); 
    ...
    mFILTER: function()  {
       ...
       try {
            // IDP.g:3223:9: ( F I L T E R )
            // IDP.g:3223:21: F I L T E R
            this.mF(); 
            this.mI(); 
            this.mL(); 
            this.mT(); 
    ...
    mGROUPED: function()  {
        try {
            // IDP.g:3224:18: ( G R O U P ( E D )? )
            // IDP.g:3224:30: G R O U P ( E D )?
            this.mG(); 
            this.mR(); 
            this.mO(); 
            this.mU(); 
    ...
    mCOUNT: function()  {
        try {
            // IDP.g:3226:16: ( C O U N T )
            // IDP.g:3226:28: C O U N T
            this.mC(); 
            this.mO(); 
            this.mU(); 
            this.mN(); 
    ...
    mCOUNTD: function()  {
       ...
       try {
            // IDP.g:3228:16: ( C O U N T D )
            // IDP.g:3228:19: C O U N T D
            this.mC(); 
            this.mO(); 
            this.mU(); 
            this.mN(); 
    ...
    mNEXT: function()  {
       ...
       try {
            // IDP.g:3231:9: ( N E X T )
            // IDP.g:3231:21: N E X T
            this.mN(); 
            this.mE(); 
            this.mX(); 
            this.mT(); 
    ...
    mTODAY: function()  {
       ...
       try {
            // IDP.g:3232:8: ( T O D A Y )
            // IDP.g:3232:20: T O D A Y
            this.mT(); 
            this.mO(); 
            this.mD(); 
            this.mA(); 
    ...
    mYESTERDAY: function()  {
       ...
       try {
            // IDP.g:3235:13: ( Y E S T E R D A Y )
            // IDP.g:3235:25: Y E S T E R D A Y
            this.mY(); 
            this.mE(); 
            this.mS(); 
            this.mT(); 
    ...
    mTOMORROW: function()  {
       ...
       try {
            // IDP.g:3238:9: ( T O M O R R O W )
            // IDP.g:3238:13: T O M O R R O W
            this.mT(); 
            this.mO(); 
            this.mM(); 
            this.mO(); 
    ...
    mBEFORE: function()  {
       ...
       try {
            // IDP.g:3239:19: ( B E F O R E )
            // IDP.g:3239:31: B E F O R E
            this.mB(); 
            this.mE(); 
            this.mF(); 
            this.mO(); 
    ...
    mAFTER: function()  {
       ...
       try {
            // IDP.g:3240:9: ( A F T E R )
            // IDP.g:3240:21: A F T E R
            this.mA(); 
            this.mF(); 
            this.mT(); 
            this.mE(); 
    ...
    mBETWEEN: function()  {
       ...
       try {
            // IDP.g:3241:17: ( B E T W E E N )
            // IDP.g:3241:29: B E T W E E N
            this.mB(); 
            this.mE(); 
            this.mT(); 
            this.mW(); 
    ...
    mCONTAIN: function()  {
        try {
            // IDP.g:3242:18: ( C O N T A I N )
            // IDP.g:3242:26: C O N T A I N
            this.mC(); 
            this.mO(); 
            this.mN(); 
            this.mT(); 
    ...
    mCONTAINS: function()  {
       ...
       try {
            // IDP.g:3243:10: ( C O N T A I N S )
            // IDP.g:3243:18: C O N T A I N S
            this.mC(); 
            this.mO(); 
            this.mN(); 
            this.mT(); 
    ...
    mWITH_FUZZY: function()  {
       ...
       try {
            // IDP.g:3245:11: ( WITH ( FWS )+ A ( FWS )+ FUZZY ( FWS )+ SCORE ( FWS )+ FOF )
            // IDP.g:3245:14: WITH ( FWS )+ A ( FWS )+ FUZZY ( FWS )+ SCORE ( FWS )+ FOF
            this.mWITH(); 
            // IDP.g:3245:19: ( FWS )+
            var cnt121=0;
            loop121:
    ...
    mEXIST: function()  {
       ...
       try {
            // IDP.g:3246:8: ( E X I S T )
            // IDP.g:3246:20: E X I S T
            this.mE(); 
            this.mX(); 
            this.mI(); 
            this.mS(); 
    ...
    mEXISTS: function()  {
       ...
       try {
            // IDP.g:3247:9: ( E X I S T S )
            // IDP.g:3247:21: E X I S T S
            this.mE(); 
            this.mX(); 
            this.mI(); 
            this.mS(); 
    ...
    mSTART: function()  {
       ...
       try {
            // IDP.g:3248:7: ( S T A R T )
            // IDP.g:3248:19: S T A R T
            this.mS(); 
            this.mT(); 
            this.mA(); 
            this.mR(); 
    ...
    mSTARTS: function()  {
       ...
       try {
            // IDP.g:3249:8: ( S T A R T S )
            // IDP.g:3249:20: S T A R T S
            this.mS(); 
            this.mT(); 
            this.mA(); 
            this.mR(); 
    ...
    mENDS: function()  {
       ...
       try {
            // IDP.g:3251:9: ( E N D S )
            // IDP.g:3251:21: E N D S
            this.mE(); 
            this.mN(); 
            this.mD(); 
            this.mS(); 
    ...
    mLIKE: function()  {
       ...
       try {
            // IDP.g:3252:11: ( L I K E )
            // IDP.g:3252:23: L I K E
            this.mL(); 
            this.mI(); 
            this.mK(); 
            this.mE(); 
    ...
    mWITH: function()  {
        try {
            // IDP.g:3253:18: ( W I T H )
            // IDP.g:3253:30: W I T H
            this.mW(); 
            this.mI(); 
            this.mT(); 
            this.mH(); 
    ...
    mALL: function()  {
       ...
       try {
            // IDP.g:3256:11: ( FALL FWS )
            // IDP.g:3256:23: FALL FWS
            this.mFALL(); 
            this.mFWS(); 
    ...
    mWHERE: function()  {
       ...
       try {
            // IDP.g:3257:7: ( W H E R E )
            // IDP.g:3257:19: W H E R E
            this.mW(); 
            this.mH(); 
            this.mE(); 
            this.mR(); 
    ...
    mTHAN: function()  {
       ...
       try {
            // IDP.g:3258:8: ( T H A N )
            // IDP.g:3258:20: T H A N
            this.mT(); 
            this.mH(); 
            this.mA(); 
            this.mN(); 
    ...
    mGREATER: function()  {
       ...
       try {
            // IDP.g:3265:18: ( G R E A T E R )
            // IDP.g:3265:30: G R E A T E R
            this.mG(); 
            this.mR(); 
            this.mE(); 
            this.mA(); 
    ...
    mLESS: function()  {
       ...
       try {
            // IDP.g:3266:10: ( L E S S )
            // IDP.g:3266:22: L E S S
            this.mL(); 
            this.mE(); 
            this.mS(); 
            this.mS(); 
    ...
    mEQUAL: function()  {
       ...
       try {
            // IDP.g:3267:18: ( E Q U A L )
            // IDP.g:3267:30: E Q U A L
            this.mE(); 
            this.mQ(); 
            this.mU(); 
            this.mA(); 
    ...
    mEQUALS: function()  {
       ...
       try {
            // IDP.g:3268:19: ( E Q U A L S )
            // IDP.g:3268:31: E Q U A L S
            this.mE(); 
            this.mQ(); 
            this.mU(); 
            this.mA(); 
    ...
    mTRUE: function()  {
       ...
       try {
            // IDP.g:3270:9: ( T R U E )
            // IDP.g:3270:21: T R U E
            this.mT(); 
            this.mR(); 
            this.mU(); 
            this.mE(); 
    ...
    mFALSE: function()  {
       ...
       try {
            // IDP.g:3271:9: ( F A L S E )
            // IDP.g:3271:21: F A L S E
            this.mF(); 
            this.mA(); 
            this.mL(); 
            this.mS(); 
    ...
    mSECOND: function()  {
       ...
       try {
            // IDP.g:3283:18: ( S E C O N D ( S )? )
            // IDP.g:3283:30: S E C O N D ( S )?
            this.mS(); 
            this.mE(); 
            this.mC(); 
            this.mO(); 
    ...
    mMINUTE: function()  {
       ...
       try {
            // IDP.g:3284:18: ( M I N U T E ( S )? )
            // IDP.g:3284:30: M I N U T E ( S )?
            this.mM(); 
            this.mI(); 
            this.mN(); 
            this.mU(); 
    ...
    mHOUR: function()  {
       ...
       try {
            // IDP.g:3285:8: ( H O U R ( S )? )
            // IDP.g:3285:20: H O U R ( S )?
            this.mH(); 
            this.mO(); 
            this.mU(); 
            this.mR(); 
    ...
    mDAY: function()  {
       ...
       try {
            // IDP.g:3286:10: ( D A Y ( S )? )
            // IDP.g:3286:22: D A Y ( S )?
            this.mD(); 
            this.mA(); 
            this.mY(); 
            // IDP.g:3286:28: ( S )?
    ...
    mWEEK: function()  {
       ...
       try {
            // IDP.g:3287:8: ( W E E K ( S )? )
            // IDP.g:3287:20: W E E K ( S )?
            this.mW(); 
            this.mE(); 
            this.mE(); 
            this.mK(); 
    ...
    mMONTH: function()  {
       ...
       try {
            // IDP.g:3288:18: ( M O N T H ( S )? )
            // IDP.g:3288:30: M O N T H ( S )?
            this.mM(); 
            this.mO(); 
            this.mN(); 
            this.mT(); 
    ...
    mYEAR: function()  {
       ...
       try {
            // IDP.g:3289:9: ( Y E A R ( S )? )
            // IDP.g:3289:21: Y E A R ( S )?
            this.mY(); 
            this.mE(); 
            this.mA(); 
            this.mR(); 
    ...
    mTHIS: function()  {
       ...
       try {
            // IDP.g:3291:10: ( T H I S )
            // IDP.g:3291:22: T H I S
            this.mT(); 
            this.mH(); 
            this.mI(); 
            this.mS(); 
    ...
    mDISTINCT: function()  {
       ...
       try {
            // IDP.g:3293:9: ( D I S T I N C T )
            // IDP.g:3293:19: D I S T I N C T
            this.mD(); 
            this.mI(); 
            this.mS(); 
            this.mT(); 
    ...
    mDOES: function()  {
        try {
            // IDP.g:3294:18: ( D O E S )
            // IDP.g:3294:30: D O E S
            this.mD(); 
            this.mO(); 
            this.mE(); 
            this.mS(); 
    ...
    mIS_NOT: function()  {
       ...
       try {
            // IDP.g:3304:8: ( IS FWS NOT FWS )
            // IDP.g:3304:19: IS FWS NOT FWS
            this.mIS(); 
            this.mFWS(); 
            this.mNOT(); 
            this.mFWS(); 
    ...
    mPARAMETER: function()  {
       ...
       try {
            // IDP.g:3335:17: ( ( ( COLON ) ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( DOT ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ) )* ) ) )
            // IDP.g:3335:33: ( ( COLON ) ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( DOT ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ) )* ) )
            // IDP.g:3335:33: ( ( COLON ) ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( DOT ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ) )* ) )
            // IDP.g:3336:48: ( COLON ) ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( DOT ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ) )* )
            // IDP.g:3336:48: ( COLON )
            // IDP.g:3336:49: COLON
            this.mCOLON(); 
            ...
            // IDP.g:3336:58: ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( DOT ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ) )* )
            // IDP.g:3336:59: ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( DOT ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ) )*
            // IDP.g:3336:59: ( '_' )?
            var alt134=2;
            ...
            // IDP.g:3336:119: ( DOT ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ) )*
            loop138:
            do {
                var alt138=2;
                ...
                switch (alt138) {
                case 1 :
                    // IDP.g:3336:120: DOT ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
                    this.mDOT(); 
                    // IDP.g:3336:124: ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
                    // IDP.g:3336:125: ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
                    // IDP.g:3336:125: ( '_' )?
                    var alt136=2;
    ...
    mIS_A: function()  {
       ...
       try {
            // IDP.g:3413:13: ( IS WS OBJECT )
            // IDP.g:3413:25: IS WS OBJECT
            this.mIS(); 
            this.mWS(); 
            this.mOBJECT(); 
    ...
    mIS_NOT_OBJ: function()  {
       ...
       try {
            // IDP.g:3417:13: ( IS WS NOT WS OBJECT )
            // IDP.g:3417:25: IS WS NOT WS OBJECT
            this.mIS(); 
            this.mWS(); 
            this.mNOT(); 
            this.mWS(); 
    ...
    mALL_OF_OBJ: function()  {
       ...
       try {
            // IDP.g:3426:5: ( ( FALL FWS O OBJECT ) )
            // IDP.g:3427:5: ( FALL FWS O OBJECT )
            // IDP.g:3427:5: ( FALL FWS O OBJECT )
            // IDP.g:3427:6: FALL FWS O OBJECT
            this.mFALL(); 
            this.mFWS(); 
            this.mO(); 
            this.mOBJECT(); 
    ...
    mOBJECT: function()  {
        ...
        try {
            // IDP.g:3455:9: ( ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // IDP.g:3455:13: ( '_' )? ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            // IDP.g:3455:13: ( '_' )?
            var alt139=2;
    ...
    mNAVIGATION: function()  {
       ...
       try {
            // IDP.g:3459:13: ( ( ( OBJECT ( DOT OBJECT )* ( DOT )? ) ) )
            // IDP.g:3460:9: ( ( OBJECT ( DOT OBJECT )* ( DOT )? ) )
            // IDP.g:3460:9: ( ( OBJECT ( DOT OBJECT )* ( DOT )? ) )
            // IDP.g:3461:17: ( OBJECT ( DOT OBJECT )* ( DOT )? )
            // IDP.g:3461:17: ( OBJECT ( DOT OBJECT )* ( DOT )? )
            // IDP.g:3461:18: OBJECT ( DOT OBJECT )* ( DOT )?
            this.mOBJECT(); 
            // IDP.g:3461:26: ( DOT OBJECT )*
            loop141:
            do {
                var alt141=2;
    ...
    mHexDigit: function()  {
        try {
            // IDP.g:3543:18: ( ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' ) )
            // IDP.g:3543:20: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )
    ...
    mStringChar: function()  {
        try {
            // IDP.g:3545:21: ( UnicodeChar | EscapeSequence )
            var alt143=2;
            ...
            switch (alt143) {
                case 1 :
                    // IDP.g:3545:24: UnicodeChar
                    this.mUnicodeChar(); 


                    break;
                case 2 :
                    // IDP.g:3545:38: EscapeSequence
    ...
    mEscapeSequence: function()  {
        try {
            // IDP.g:3546:31: ( '\\\\' ( '\\\\' | '/' | 'b' | 'f' | 'n' | 'r' | 't' | 'u' HexDigit HexDigit HexDigit HexDigit | ( WS )+ ) )
            // IDP.g:3546:33: '\\\\' ( '\\\\' | '/' | 'b' | 'f' | 'n' | 'r' | 't' | 'u' HexDigit HexDigit HexDigit HexDigit | ( WS )+ )
            this.match('\\'); 
            // IDP.g:3546:38: ( '\\\\' | '/' | 'b' | 'f' | 'n' | 'r' | 't' | 'u' HexDigit HexDigit HexDigit HexDigit | ( WS )+ )
            var alt145=9;
            ...
            switch (alt145) {
                ...
                case 7 :
                    ...
                    break;
                case 8 :
                    // IDP.g:3546:92: 'u' HexDigit HexDigit HexDigit HexDigit
                    this.match('u'); 
                    this.mHexDigit(); 
                    this.mHexDigit(); 
                    this.mHexDigit(); 
    ...
    mSTRING: function()  {
       ...
       try {
            // IDP.g:3559:13: ( '\\'' ( StringChar )* '\\'' )
            // IDP.g:3559:15: '\\'' ( StringChar )* '\\''
            this.match('\''); 
            // IDP.g:3559:20: ( StringChar )*
            loop146:
            do {
                var alt146=2;
    ...
    mIntWithComma: function()  {
        try {
            // IDP.g:3593:22: ( IntSimple ( Comma ( Digit Digit Digit ) )* )
            // IDP.g:3593:25: IntSimple ( Comma ( Digit Digit Digit ) )*
            this.mIntSimple(); 
            // IDP.g:3593:37: ( Comma ( Digit Digit Digit ) )*
            loop148:
            do {
                var alt148=2;
                ...
                switch (alt148) {
                case 1 :
                    // IDP.g:3593:38: Comma ( Digit Digit Digit )
                    this.mComma(); 
                    // IDP.g:3593:44: ( Digit Digit Digit )
                    // IDP.g:3593:45: Digit Digit Digit
                    this.mDigit(); 
                    this.mDigit(); 
                    this.mDigit(); 
    ...
    mIntWithDot: function()  {
        try {
            // IDP.g:3599:20: ( IntSimple ( DOT ( Digit Digit Digit ) )* )
            // IDP.g:3599:23: IntSimple ( DOT ( Digit Digit Digit ) )*
            this.mIntSimple(); 
            // IDP.g:3599:35: ( DOT ( Digit Digit Digit ) )*
            loop149:
            do {
                var alt149=2;
                ...
                switch (alt149) {
                case 1 :
                    // IDP.g:3599:36: DOT ( Digit Digit Digit )
                    this.mDOT(); 
                    // IDP.g:3599:40: ( Digit Digit Digit )
                    // IDP.g:3599:41: Digit Digit Digit
                    this.mDigit(); 
                    this.mDigit(); 
                    this.mDigit(); 
    ...
    mIntWithSpace: function()  {
        try {
            // IDP.g:3606:22: ( IntSimple )
            // IDP.g:3606:24: IntSimple
            this.mIntSimple(); 
    ...
    mZERO_TO_ONE: function()  {
       ...
       try {
            // IDP.g:3609:13: ( ({...}? => '0' DOT IntSimple ) | ({...}? => '0' Comma IntSimple ) )
            var alt150=2;
            ...
            switch (alt150) {
                case 1 :
                    // IDP.g:3610:2: ({...}? => '0' DOT IntSimple )
                    // IDP.g:3610:2: ({...}? => '0' DOT IntSimple )
                    // IDP.g:3610:3: {...}? => '0' DOT IntSimple
                    ...
                    break;
                case 2 :
                    // IDP.g:3613:2: ({...}? => '0' Comma IntSimple )
                    // IDP.g:3613:2: ({...}? => '0' Comma IntSimple )
                    // IDP.g:3613:3: {...}? => '0' Comma IntSimple
    ...
    mINT: function()  {
       ...
       try {
            // IDP.g:3616:5: ( ({...}? => IntSimple ) | ({...}? => IntWithComma ) | ({...}? => IntWithDot ) | ({...}? => IntWithSpace ) )
            var alt151=4;
            ...
            switch (alt151) {
                case 1 :
                    // IDP.g:3617:6: ({...}? => IntSimple )
                    // IDP.g:3617:6: ({...}? => IntSimple )
                    // IDP.g:3617:7: {...}? => IntSimple
                    ...
                    break;
                case 2 :
                    // IDP.g:3618:6: ({...}? => IntWithComma )
                    // IDP.g:3618:6: ({...}? => IntWithComma )
                    // IDP.g:3618:7: {...}? => IntWithComma
                    ...
                    break;
                case 3 :
                    // IDP.g:3619:6: ({...}? => IntWithDot )
                    // IDP.g:3619:6: ({...}? => IntWithDot )
                    // IDP.g:3619:7: {...}? => IntWithDot
                    ...
                    break;
                case 4 :
                    // IDP.g:3620:6: ({...}? => IntWithSpace )
                    // IDP.g:3620:6: ({...}? => IntWithSpace )
                    // IDP.g:3620:7: {...}? => IntWithSpace
    ...
    mDECIMAL: function()  {
       ...
       try {
            // IDP.g:3622:9: ( ({...}? => IntSimple DOT IntSimple ) | ({...}? => IntWithDot Comma IntSimple ) | ({...}? => IntWithComma DOT IntSimple ) | ({...}? => IntWithSpace Comma IntSimple ) )
            var alt152=4;
            	alt152 = this.dfa152.predict(this.input);	
            switch (alt152) {
                case 1 :
                    // IDP.g:3623:6: ({...}? => IntSimple DOT IntSimple )
                    // IDP.g:3623:6: ({...}? => IntSimple DOT IntSimple )
                    // IDP.g:3623:7: {...}? => IntSimple DOT IntSimple
                    this.setPred(!this.localeConversionLib.isLocaleExistsInFlags(this.parseModelLib.getModelManger()) || (this.localeConversionLib.isLocaleExistsInFlags(this.parseModelLib.getModelManger()) && this.localeConversionLib.isLocaleConversionFromCodeText(this.parseModelLib.getModelManger().flags)));
                    if ( !((!this.localeConversionLib.isLocaleExistsInFlags(this.parseModelLib.getModelManger()) || (this.localeConversionLib.isLocaleExistsInFlags(this.parseModelLib.getModelManger()) && this.localeConversionLib.isLocaleConversionFromCodeText(this.parseModelLib.getModelManger().flags)))) ) {
                    ...
                    break;
                case 2 :
                    // IDP.g:3624:6: ({...}? => IntWithDot Comma IntSimple )
                    // IDP.g:3624:6: ({...}? => IntWithDot Comma IntSimple )
                    // IDP.g:3624:7: {...}? => IntWithDot Comma IntSimple
                    ...
                    break;
                case 3 :
                    // IDP.g:3625:6: ({...}? => IntWithComma DOT IntSimple )
                    // IDP.g:3625:6: ({...}? => IntWithComma DOT IntSimple )
                    // IDP.g:3625:7: {...}? => IntWithComma DOT IntSimple
                    ...
                    break;
                case 4 :
                    // IDP.g:3626:6: ({...}? => IntWithSpace Comma IntSimple )
                    // IDP.g:3626:6: ({...}? => IntWithSpace Comma IntSimple )
                    // IDP.g:3626:7: {...}? => IntWithSpace Comma IntSimple
    ...
    mML_COMMENT: function()  {
       ...
       try {
            // IDP.g:3632:12: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // IDP.g:3632:14: '/*' ( options {greedy=false; } : . )* '*/'
            this.match("/*"); 

            // IDP.g:3632:19: ( options {greedy=false; } : . )*
            loop153:
            do {
                var alt153=2;
...
org.antlr.lang.extend(IDPLexer.DFA152, org.antlr.runtime.DFA, {
    getDescription: function() {
        return "3622:1: DECIMAL : ( ({...}? => IntSimple DOT IntSimple ) | ({...}? => IntWithDot Comma IntSimple ) | ({...}? => IntWithComma DOT IntSimple ) | ({...}? => IntWithSpace Comma IntSimple ) );";
    },
