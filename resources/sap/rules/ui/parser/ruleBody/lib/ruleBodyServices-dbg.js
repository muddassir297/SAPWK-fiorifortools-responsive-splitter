...
sap.rules.ui.parser.ruleBody.lib.ruleBodyServices.lib = (function() {
	 ...
	 * @returns
	 */
	RuleBodyServicesLib.prototype.parseRootObjectContext = function parseRootObjectContext(ruleId, ruleBody, output, vocabulary, vocaDataProvider){
		var flags = {};
		...
		return this.process(ruleBody, vocabulary, vocaDataProvider, flags, output, null);
	};
