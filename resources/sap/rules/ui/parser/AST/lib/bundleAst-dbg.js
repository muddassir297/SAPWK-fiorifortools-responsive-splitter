...
/***/ function(module, exports) {
	...
	AstNodes_lib = function() {
	    ...
	    ASTNode.prototype.setParent = function getKind(parentNode) {
	    ...
	    ASTNode.prototype.deserialize = function deserialize(nodeObj, astNodesConstructors) {
	        ...
	        if (nodeObj.hasOwnProperty('syntaxBox') && nodeObj.syntaxBox.length > 0) {
	            ...
	            for (idx = 0; idx < nodeObj.syntaxBox.length; idx++) {
	                ...
	                //var token = new Token(image, startOffset, startLine, startColumn, endLine, endColumn)
	            }
	        }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AstOperations_lib;

	AstOperations_lib = function() {
	    ...
	    function split (leftExprNode, allASTNodes, operatorNode){
	        ...
	        var mostLeftAST;
	        var ASTParts =  null;
	        var allASTNodesCopy = allASTNodes? Object.assign({}, allASTNodes): null;
	        ...
	        function addConnectorNodesToSplittingArea(splitNode, operatorNode, allAST){
	            ...
	            if(operatorNode){
	                ...
	                restNode = new astNodes.ConnectorNode();
	                if(splitNodeParent.children.length > 0){
	                    for(var idx=1; idx < splitNodeParent.children.length; idx++){
	                        restNode.addChild(splitNodeParent.children[idx]);
	                        //splitNodeParent.children[idx] = new astNodes.ConnectorNode();
	                    }
	                ...
	                parts.left = splitNode.parent;
	                parts.operator = null;
	                splitNodeParent.children[0] = new astNodes.ConnectorNode();
	                parts.rest = allAST;
	            }
	        ...
	        if(allASTNodesCopy && leftExprNode){
	            ...
	            if (mostLeftAST) { //equal to all AST or mostLeft is part of the allAST
