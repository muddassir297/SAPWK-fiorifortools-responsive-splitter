...
sap.ui.define(function() {
    ...
    VizFrameOptionsHelper.processWaterfallProperty = function(savedOptions, inputOptions){
        var plotArea = inputOptions.plotArea;
        if(plotArea){
    ...
    */
    VizFrameOptionsHelper.decorateTimeBullet = function(options) {
        jQuery.extend(true, options.properties, {plotArea:{}});
        var plotArea = options.properties.plotArea;
        if (!plotArea.actualColor) {
    ...
    VizFrameOptionsHelper.decorateWaterfall = function(options, feeds) {
        if (!feeds || feeds.length === 0) {
            return;
        }
