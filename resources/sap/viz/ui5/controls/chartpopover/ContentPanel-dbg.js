...
function(jQuery, ShapeMarker, Control, SimpleForm, Grid, Text, ObjectNumber, Label, TextAlign) {
    "use strict";
    ...
    ContentPanel.prototype.setContentData = function(data) {       
        ...
        if (values) {
            ...
            var isPeriodicWaterfall = function() {
                var result = false;
            ...
            if (!isPeriodicWaterfall() && typeof data.color === 'string') {
