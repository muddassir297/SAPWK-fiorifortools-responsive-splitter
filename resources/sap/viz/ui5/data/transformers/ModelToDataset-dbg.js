...
sap.ui.define(function() {
	...
	var ModelToDataset = function() {
	    this.reset();
	};

	ModelToDataset.prototype.reset = function(oOther) {
	    this._oVIZCrosstab = null;
	    this._aCrossContextLookup = null;
	};

	ModelToDataset.prototype.getVizDataset = function(oBinding, dimensions, measures, defaultSelectionInfo, info) {
	...
	ModelToDataset.prototype.findContext = function(oCriteria) {
	...
	ModelToDataset.prototype._createVIZCrosstab = function(oBinding, dimensions, measures, defaultSelectionInfo, info) {
