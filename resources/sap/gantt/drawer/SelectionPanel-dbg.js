...
sap.ui.define([
	...
	SelectionPanel.prototype.drawSvg = function (aTableSvg, aData, iTableHeaderWidth, oGanttChartWithTable) {
		...
		if (!aTableCntPanelG.empty()) {
			...
			this._drawExpandedBackground(aTableCntPanelG, iTableWidth, iTableHeaderWidth, aExpandedData);
			this._drawExpandedContent(aTableCntPanelG, iTableWidth,  iTableHeaderWidth, aExpandedData);
		}
	};

	SelectionPanel.prototype._drawExpandedBackground = function (aSvg, iTableWidth, iTableHeaderWidth, aDatas) {		

		var aHederBGRect = aSvg.selectAll(".sapGanttExpandChartHeaderBG").data(aDatas);
		aHederBGRect.enter().append("rect").classed("sapGanttExpandChartHeaderBG",true);
		...
		var aCntBGRect = aSvg.selectAll(".sapGanttExpandChartCntBG").data(aDatas);
		aCntBGRect.enter().append("rect").classed("sapGanttExpandChartCntBG",true);
