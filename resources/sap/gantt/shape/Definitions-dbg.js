...
sap.ui.define([
	 ...
	 * of a 'defs'. The 'childTagName' is the name of any child element of 'defs'.See {@link https://www.w3.org/TR/SVG/struct.html#DefsElement SVG 1.1 specification for defs}.<br/>
	 * 
	 * @param {object} oData Shape data.
	 * @param {object} oRowInfo Information about the row and the row data.
