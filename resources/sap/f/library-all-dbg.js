...
if ( !jQuery.sap.isDeclared('sap.f.routing.Route') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2017 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('sap.f.routing.Route'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('sap.ui.core.routing.Route'); // unlisted dependency retained
sap.ui.define("sap/f/routing/Route",['sap/ui/core/routing/Route'],
	function (CoreRoute) {
		"use strict";
...
sap.ui.define("sap/f/routing/Target",['sap/ui/core/routing/Target', './async/Target'],
...
sap.ui.define("sap/f/routing/Router",['sap/ui/core/routing/Router', './TargetHandler', './Targets', './Route'],
...
sap.ui.define("sap/f/semantic/AddAction",['sap/f/semantic/SemanticButton'], function(SemanticButton) {
	...
	*
	* @class
	* A <code>AddAction</code> button has default semantic-specific properties
	* and it`s placed in the <code>SemanticPage</code> title.
	* The <code>AddAction</code> is eligible for aggregation content of a {@link sap.f.semantic.SemanticPage}.
	*
	* @extends <code>sap.f.semantic.SemanticButton</code>
	*
	* @author SAP SE
