...
(function() {
	...
	*/
	...
	sap.apf.utils.extractOdataErrorResponse = function(response) {
		...
		var message = ( responseObject && responseObject.error && responseObject.error.message && responseObject.error.message.value ) || 
					  ( responseObject && responseObject.error && responseObject.error.message && responseObject.error.message) ||
						response;
