...
(function() {
	...
	sap.ui.core.mvc.Controller.extend("sap.apf.modeler.ui.controller.sortPropertyType", {
		...
		handleChangeForSortProperty : function() {
			...
			var sNewSortProperty = oTextManipulator.removePrefixText(oController.byId("idSortProperty").getSelectedKey(), sap.apf.modeler.ui.utils.CONSTANTS.texts.NOTAVAILABLE);
		...
		handleChangeForSortDirection : function() {
			var oController = this;
			var sSortProperty = oTextManipulator.removePrefixText(oController.byId("idSortProperty").getSelectedKey(), sap.apf.modeler.ui.utils.CONSTANTS.texts.NOTAVAILABLE);
