...
(function() {
	...
	sap.ui.controller("sap.apf.modeler.ui.controller.propertyTypeHandler", {
		...
		handlePressOfAdd : function(oEvent) {
			...
			oSourceView.attachEvent(oConstants.REMOVEADDEDPROPERTYFROMOTHERPROPERTYTYPE, oController.handleRemovalOfAddedProperty.bind(oController));
		...
		handlePressOfRemove : function(oEvent) {
			...
			var oVbox = oController.byId("idPropertyTypeVBox");
			var oSourceView = oEvent.getSource();
			oSourceView.attachEvent(oConstants.ADDREMOVEDPROPERTYFROMOTHERPROPERTYTYPE, oController.handleAdditionOfRemovedProperty.bind(oController));
			var nIndexOfSourceView = oVbox.indexOfItem(oSourceView);
