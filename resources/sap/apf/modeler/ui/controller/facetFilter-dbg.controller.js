...
(function() {
	...
	function _setDisplayText(oController) {
		...
		oController.byId("idFilterResolutionTitle").setText(oTextReader("filterResolution"));
	...
	sap.ui.controller("sap.apf.modeler.ui.controller.facetFilter", {
		...
		handleChangeForProperty : function() {
			...
			sFacetFilterProperty = textManipulator.removePrefixText(sFacetFilterProperty, sap.apf.modeler.ui.utils.CONSTANTS.texts.NOTAVAILABLE);
