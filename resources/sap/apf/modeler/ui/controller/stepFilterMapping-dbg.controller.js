...
(function() {
	...
	sap.apf.modeler.ui.controller.requestOptions.extend("sap.apf.modeler.ui.controller.stepFilterMapping", {
		...
		getSelectedKeysForProperties : function() {
			...
			sSelectedKey = textManipulator.removePrefixText(oController.byId("idOptionalRequestField").getSelectedKey(), sap.apf.modeler.ui.utils.CONSTANTS.texts.NOTAVAILABLE);
		...
		setDisplayText : function() {
			...
			oController.byId("idOptionalRequestFieldLabel").setText(oTextReader("filterMapTarget"));
		},
		...
		updateFilterMappingFields : function() {
			...
			if (nullObjectChecker.checkIsNotNullOrUndefinedOrBlank(sSource)) {
				...
				//set properties
				sSelectProperty = textManipulator.removePrefixText(oController.byId("idOptionalRequestField").getSelectedKey(), sap.apf.modeler.ui.utils.CONSTANTS.texts.NOTAVAILABLE);
