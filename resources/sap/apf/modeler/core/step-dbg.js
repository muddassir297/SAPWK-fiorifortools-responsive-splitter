...
(function() {
	...
	sap.apf.modeler.core.Step = function(stepId, inject, dataFromCopy) {
		...
		this.getConsumablePropertiesForTopN = function (){
			...
			getAvailableProperties.call(this).done(function(availableProperties){
				...
				deferred.resolve(getConsumableProperties(availableProperties, selectedProperties));
			});
		...
		function getConsumableProperties(availableProperties, selectedProperties) {
