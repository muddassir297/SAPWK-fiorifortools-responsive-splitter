...
(function() {
	...
	sap.apf.modeler.core.Representation = function(representationId, inject, dataFromCopy) {
		var representationTypeId, alternateRepresentationTypeId, width, dimensions, measures, properties, leftUpperCornerTextKey, rightUpperCornerTextKey, leftLowerCornerTextKey, rightLowerCornerTextKey, orderByProperties, topN, hierarchyProperty, hierarchyPropertyTextLabelKey;
		if (!dataFromCopy) {
			width = {};
