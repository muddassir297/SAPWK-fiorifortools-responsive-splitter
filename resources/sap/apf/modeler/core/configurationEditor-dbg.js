...
(function () {
	...
	sap.apf.modeler.core.ConfigurationEditor = function (configuration, inject, callbackAfterLoad, dataFromCopy) {
		 ...
		 * @private
		 * @function
		 * @name sap.apf.modeler.core.ConfigurationEditor#getAllEntityTypesOfServiceAsPromise
		 * @description Returns all entity types of service.
		 * @param {String} serviceRoot 
		 * @returns {jQuery.Deferred.promise} 
		 */
		this.getAllEntityTypesOfServiceAsPromise = function(serviceRoot) {
			var deferred = jQuery.Deferred();
			if(serviceList.indexOf(serviceRoot) > -1) {
				metadataFactory.getEntityTypes(serviceRoot).done(function(entityTypes){
