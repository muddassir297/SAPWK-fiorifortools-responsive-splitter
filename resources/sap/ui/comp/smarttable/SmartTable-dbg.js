...
sap.ui.define([
	...
	var SmartTable = VBox.extend("sap.ui.comp.smarttable.SmartTable", /** @lends sap.ui.comp.smarttable.SmartTable.prototype */
	{
		metadata: {
			...
			events: {
				 ...
				 * @param {JSON} oControlEvent.getParameters.bindingParams The bindingParams object contains filters, sorters and other binding
				 ...
				 *        instances of the SmartTable and SmartFilter controls; can be modified by users to influence filtering
				 ...
				 *        SmartTable control (personalization); can be modified by users to influence sorting
				 * @since 1.26.0
				 * @public
				 */
				beforeRebindTable: {},
				...
				/**
				 * This event is fired right after the full screen mode of the SmartTable control is changed.
				 * 
				 * @since 1.46
				 */
				fullScreenToggled: {
					parameters: {
						/**
						 * If <code>true</code> then the control is in full screen, else not.
						 */
						fullScreen: {
							type: "boolean"
						}
	...
	SmartTable.prototype._filterChangeEvent = function() {
		if (this._isTableBound() && this._oSmartFilter && !this._oSmartFilter.getLiveMode()) {
