...
sap.ui.define([
...
], function(jQuery, NumberFormat, BooleanType, DateTimeType, DateTimeOffsetType, DecimalType, Int16Type, Int32Type, Int64Type, SByteType, StringType, AbapBoolean, CurrencyType, TimeType, MetadataAnalyser) {
	"use strict";
	...
	ODataTypes.prototype._getStringConstraints = function(oProperty) {
		var iMaxLength, oEquals, oBindingInfo, mConstraints = {};

		// get the binding info
		oBindingInfo = this._oParent.getBindingInfo("value");
