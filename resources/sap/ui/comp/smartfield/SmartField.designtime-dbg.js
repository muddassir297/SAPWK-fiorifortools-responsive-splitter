...
sap.ui.define([], function() {
	...
	return {
		annotations: {
			 ...
			 * In addition, formatting leading zeros are removed from the value.
			 * Intended for <code>Edm.String</code> properties that are stored as ABAP <code>NUMC</code> (numeric text) data
			 * type.
			 *
