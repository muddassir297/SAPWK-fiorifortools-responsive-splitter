			...
			switch (oProperty.property.type) {
				...
				case "Edm.String":
					fReturn = function(sValue) {
						if (that._oParent && that._oParent.getMandatory() && that._oParent.getClientSideMandatoryCheck() && (!that._oAnnotation || !that._oAnnotation.isStaticMandatory(oProperty.property) || !that._oAnnotation.isNullable(oProperty.property)) && !sValue) {
				...
				case "Edm.SByte":
					fReturn = function(sValue) {
						if (that._oParent && that._oParent.getMandatory() && that._oParent.getClientSideMandatoryCheck() && (!that._oAnnotation || !that._oAnnotation.isStaticMandatory(oProperty.property) || !that._oAnnotation.isNullable(oProperty.property)) && (sValue === null || sValue === undefined || sValue === "")) {
							throw new ParseException(sap.ui.getCore().getLibraryResourceBundle("sap.ui.comp").getText("VALUEHELPVALDLG_FIELDMESSAGE"));
						}
					};
					break;
