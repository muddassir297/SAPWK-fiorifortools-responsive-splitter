...
// Provides Controller
sap.ui.define([
	'jquery.sap.global', 'sap/ui/base/ManagedObject', './ColumnsController', './FilterController', './GroupController', './SortController', './DimeasureController', './SelectionController', './Util', 'sap/ui/comp/library', './ChartWrapper', './SelectionWrapper', './ColumnHelper', 'sap/ui/core/MessageType'
], function(jQuery, ManagedObject, ColumnsController, FilterController, GroupController, SortController, DimeasureController, SelectionController, Util, CompLibrary, ChartWrapper, SelectionWrapper, ColumnHelper, MessageType) {
	"use strict";
	...
	Controller.prototype._mergeSettingCurrentBy = function(oSetting) {
		...
		if (this.getTable() instanceof ChartWrapper) {
			this._oSettingCurrent = Util.copy(this._oSettingOriginalChart);
		} else if (this.getTable() instanceof SelectionWrapper) {
		...
		this._oSettingOriginalSelection = {
			selection: {
				controller: new SelectionController({
					columnHelper: this._oColumnHelper,
					afterSelectionModelDataChange: function(oEvent) {
						that._fireChangeEvent();
					},
					beforePotentialTableChange: function(oEvent) {
						that.fireBeforePotentialTableChange();
