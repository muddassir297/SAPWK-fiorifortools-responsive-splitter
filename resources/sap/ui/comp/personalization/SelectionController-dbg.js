...
sap.ui.define([
	'jquery.sap.global', './BaseController', 'sap/m/library', 'sap/ui/comp/library', './Util'
	...
	SelectionController.prototype.getPanel = function(oPayload) {
		...
		var oPanel = new sap.m.P13nSelectionPanel({
			...
			selectionItems: {
				...
				template: new sap.m.P13nSelectionItem({
					columnKey: "{$sapmP13nPanel>columnKey}",
	...
	SelectionController.prototype.getChangeData = function(oDataBase, oDataCompare) {
		...
		var aToBeDeleted = [];
		oChangeData.selection.selectionItems.forEach(function(oItemOld, iIndex) {
...
// if (oItemNew[property] === undefined) {
...
// }
		...
		aToBeDeleted.forEach(function(oItemOld) {
			var iIndex = Util.getIndexByKey(oChangeData.selection.selectionItems, oItemOld.columnKey);
	...
	SelectionController.prototype.getUnionData = function(oDataOld, oDataNew) {
		...
		oDataOld.selection.selectionItems.forEach(function(oSelectionItemOld, iIndex) {
