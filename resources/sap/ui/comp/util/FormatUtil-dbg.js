...
sap.ui.define([
	...
	var FormatUtil = {
		 ...
		 * @param {string} sId The Id field value
		 * @param {string} sDescription The Description field value
		 * @param {boolean} bIncludeSeparator If true, the second text value is embraced in brackets
		 * @returns {object} Object with first and second text values based on the displayBehaviour
		 * @private
		 */
		getTextsFromDisplayBehaviour: function(sDisplayBehaviour, sId, sDescription) {
			if (!sId) {
				return {
					firstText: sDescription ? sDescription : "",
