		...
		if (oItem.getGlobal()) {
			...
			var fOkay = function(sPackage, sTransport) {
				...
				if (that.getShowSetAsDefault()) {
					if (oItem.getKey() === that.sNewDefaultKey) {
						that.oManagementTable.getItems()[0].getCells()[nDefaultColumn].setSelected(true);
			...
			if (this.getShowSetAsDefault()) {
				if (oItem.getKey() === this.sNewDefaultKey) {
					this.oManagementTable.getItems()[0].getCells()[nDefaultColumn].setSelected(true);
