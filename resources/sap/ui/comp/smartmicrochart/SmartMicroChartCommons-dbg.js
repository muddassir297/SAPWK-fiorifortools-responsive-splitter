...
sap.ui.define('sap/ui/comp/smartmicrochart/SmartMicroChartCommons',
	 ...
	 * @private
	 * @param {String} chartType The expected chart type of the metadata taken from the vocabulary
	...
	Commons._checkChartMetadata = function() {
		...
		if (Commons._hasMember(this, "_oChartViewMetadata.annotation.ChartType")) {
			var sChartType = this.getChartType();
			if (this._oChartViewMetadata.annotation.ChartType.EnumMember === "com.sap.vocabularies.UI.v1.ChartType/" + sChartType) {
				return true;
			} else {
				jQuery.sap.log.error("The ChartType property in the Chart annotation is not \"" + sChartType + "\".");
				return false;
			}
		} else {
