...
sap.ui.define(['jquery.sap.global', 'sap/ui/comp/library', 'sap/ui/core/Control', 'sap/suite/ui/microchart/library', 'sap/ui/core/CustomData', 'sap/ui/comp/smartmicrochart/SmartMicroChartCommons', 'sap/m/library'],
	function(jQuery, library, Control, MicroChartLibrary, CustomData, SmartMicroChartCommons, MobileLibrary) {
	"use strict";
	...
	var SmartRadialMicroChart = Control.extend("sap.ui.comp.smartmicrochart.SmartRadialMicroChart", /** @lends sap.ui.comp.smartmicrochart.SmartRadialMicroChart.prototype */ {
		metadata : {
			...
			associations : {
				 ...
				 * annotation should be annotated with this free text.
				 */
				freeText : {
					type : "sap.m.Label",
					group : "Misc",
