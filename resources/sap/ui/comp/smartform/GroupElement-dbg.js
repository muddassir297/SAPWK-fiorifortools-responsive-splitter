...
sap.ui.define([
	...
	GroupElement.prototype.updateLabelOfFormElement = function(aInnerElements, oSourceSmartField) {
		var oTooltip = null, bCreated = false, oRelevantField = null, oLabel = null;
	...
	GroupElement.prototype.addAggregation = function(sAggregationName, oObject, bSuppressInvalidate) {
		if (sAggregationName === "elements") {
			return this.addElement(oObject);
		} else {
			return Element.prototype.addAggregation.apply(this, arguments);
		}
	};

	GroupElement.prototype.insertAggregation = function(sAggregationName, oObject, iIndex, bSuppressInvalidate) {
		if (sAggregationName === "elements") {
			return this.insertElement(oObject, iIndex);
		} else {
	...
	GroupElement.prototype.removeAggregation = function(sAggregationName, oObject) {
		if (sAggregationName === "elements") {
			return this.removeElement(oObject);
		} else {
