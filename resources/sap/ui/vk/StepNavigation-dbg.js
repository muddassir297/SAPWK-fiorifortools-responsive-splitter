...
sap.ui.define([
	"jquery.sap.global", "./library", "sap/ui/core/Control", "sap/ui/core/ResizeHandler", "./Loco", "./ViewportHandler", "sap/ui/core/Popup", "sap/ui/core/IconPool", "./Messages", "./DvlException"
], function(jQuery, library, Control, ResizeHandler, Loco, ViewportHandler, Popup, IconPool, Messages, DvlException) {
		"use strict";
		...
		StepNavigation.prototype.setGraphicsCore = function(graphicsCore) {
			if (graphicsCore != this._graphicsCore) {
				if (this._graphicsCore) {
					var oldDvl = this._graphicsCore.getApi(sap.ui.vk.GraphicsCoreApi.LegacyDvl);
					oldDvl.Client.detachStepEvent(this._onStepEvent, this);
				}
		...
		StepNavigation.prototype._highlightStep = function(stepId) {
			...
			if (that.getVisible()) {
				...
				if (that.getShowStepInfo()) {
					oSettings.stepInfo.openPopup(stepInfo.name, stepInfo.description, oShowStepInfoButton, placement);
