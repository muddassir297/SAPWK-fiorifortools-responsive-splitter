...
sap.ui.define([
	...
	function(jQuery, library, Control, Loco) {
		...
		RedlineSurface.prototype.importJSON = function(jsonElements) {
			...
			jQuery.sap.require("sap.ui.vk.RedlineElementRectangle");
			jQuery.sap.require("sap.ui.vk.RedlineElementEllipse");
			jQuery.sap.require("sap.ui.vk.RedlineElementFreehand");
