...
sap.ui.define([
	...
	SceneTree.prototype._expandToNode = function(nodeId, callback) {
			...
			setTimeout(function() {
				if (ancestors.length) {
					...
					if (scrollIndex !== null) {
						...
						tree.getBinding("rows").detachChange(expandHandler.bind(this, processAncestors));
						callback();
					}
				}
			}, 70);
		...
		this._tree.getBinding("rows").attachChange(expandHandler.bind(this, processAncestors, this._tree, ancestors));
