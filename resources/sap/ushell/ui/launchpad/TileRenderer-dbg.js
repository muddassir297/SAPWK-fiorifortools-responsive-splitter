...
sap.ui.define(['sap/ushell/resources'],
    ...
    TileRenderer.render = function (oRm, oControl) {
        ...
        oRm.writeAttribute("aria-describedby", oControl.getParent().getId() + "-titleText");
        ...
        if (this.renderTileView) {
            this.renderTileView(oRm, oTileView, oPinButton, oControl.getTarget());
        }
    ...
    TileRenderer.renderTileView = function (oRm, oTileView, oPinButton, sTarget) {
        if ((sTarget || "") !== "") {
            oRm.write("<a");
            oRm.writeClasses();
