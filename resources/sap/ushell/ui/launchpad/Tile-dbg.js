    ...
    Tile.prototype.onfocusin = function (oEvent) {
        ...
        if (!bPlusTile) {
           ...
           if (temp && temp.children && temp.children[0]) {
               ...
               var labelledbyArray = [sAccessibilityTileTextId, sTileInnerId, deleteIconId, sCatalogGroupId];
               this.getDomRef().setAttribute("aria-labelledby", labelledbyArray.join(" "));
           }
        }
    };
