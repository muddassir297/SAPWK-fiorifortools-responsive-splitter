...
sap.ui.define(function() {
    ...
    TileContainerUtils.applyFilterOnItem = function (elementsToDisplay, filters) {
        var filter;
...
//                    this.indexingMaps.onScreenPathIndexMap[oOnScreenElement].isVisible = false;
    ...
    TileContainerUtils.applyFilterOnAllItems = function (oBindingInfo, filters) {
        ...
        for (iBindingcontextIndex = 0; iBindingcontextIndex < aBindingContexts.length; iBindingcontextIndex++) {
            ...
            TileContainerUtils.applyFilterOnItem(aBindingContexts[iBindingcontextIndex], filters);
