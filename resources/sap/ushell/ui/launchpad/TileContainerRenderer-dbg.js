...
sap.ui.define(['sap/ushell/resources'],
    ...
    TileContainerRenderer.render = function (oRm, oControl) {
        ...
        //Links rendering
        var bLineModeContainer = window.location.search.indexOf("new_links_container=true") !== -1;
        if (aLinks.length > 0 || bLineModeContainer) {
            ...
            if (!aLinks.length && bLineModeContainer) {
                oRm.addClass("sapUshellNoLinksArePresent");
                oRm.writeClasses();
                oRm.write(">");
                oRm.write("<div")
                oRm.addClass("sapUshellNoLinksArePresentText");
                oRm.writeClasses();
                oRm.write(">");
