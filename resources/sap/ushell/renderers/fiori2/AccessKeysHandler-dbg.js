    ...
    accessKeysHandler.prototype = {
        ...
        init: function (oModel) {
            ...
            document.addEventListener("keydown",function (e) {
                if (e.keyCode == jQuery.sap.KeyCodes.ARROW_UP || e.keyCode == jQuery.sap.KeyCodes.ARROW_DOWN) {
                    if (!e.ctrlKey || e.doNotInterrupt) {
                        return true;
                    }
                    try {
                    ...
                    jQuery.extend(newEvent, e);
                    e.preventDefault();
                    e.stopPropagation();
                    e.stopImmediatePropagation();
                    newEvent.doNotInterrupt = true;
