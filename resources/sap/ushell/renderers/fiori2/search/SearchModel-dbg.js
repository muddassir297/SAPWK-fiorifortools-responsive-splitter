...
(function(global) {
    ...
    jQuery.sap.require("sap.ushell.renderers.fiori2.search.eventlogging.EventLogger");
    ...
    var SearchNavigationObject = sap.ushell.renderers.fiori2.search.SearchNavigationObject;
    var EventLogger = sap.ushell.renderers.fiori2.search.eventlogging.EventLogger;
    ...
    sap.ui.model.json.JSONModel.extend("sap.ushell.renderers.fiori2.search.SearchModel", {
        ...
        getServerDataSources: function() {
            ...
            that.getDataSourcesDeffered = that.sina.getDataSources().then(function(dataSources) {
                ...
                error.keep = true;
                error.type = 'warning';
                error.message = sap.ushell.resources.i18n.getText('searchScopeDeterminationErrorMessage');
        ...
        _firePerspectiveQuery: function(deserializationIn, preserveFormerResultsIn) {
            ...
            this.initPersonalization().then(doFirePerspectiveQueryWrapper).always(function() {
