...
(function() {
    ...
    impl_odata2_chart = function(base, helper) {
        ...
        exports.ChartQuery.prototype = helper.extend({}, base.ChartQuery.prototype, {
            ...
            addDimension: function(dimension) {
                if (typeof dimension === 'object') {
                    if (Object.keys(dimension).length === 0 || !dimension.name) {
                        return;
                    }
    ...
    impl_odata2_search = function(base, helper) {
        /* eslint camelcase:0 */
        var exports = {};
        // =======================================================================
        // search query
        ...
        */
        ...
        exports.Condition.prototype = helper.extend(Object.create(filter.Condition.prototype), {
            ...
            getDataForRequest: function() {
                ...
                return conditionObj; //            return this.attribute + " " + nomalizeOperator(this.operator) + " '" + this.value + "'";
            }
        });
        exports.ConditionGroup = function() {
            this.init.apply(this, arguments);
        ...
        exports.ConditionGroup.prototype = helper.extend(Object.create(filter.ConditionGroup.prototype), {
            ...
            getDataForRequest: function() {
                ...
                if (result.length >= 1) {
                    resultStr = {
                        'Id': 1,
                        'OperatorType': this.operator.toUpperCase(),
                        'SubFilters': result
                    };
                }
                //            var resultStr = result.join(' ' + nomalizeOperator(this.operator) + ' ');
    ...
    impl_odata3_datasource = function(datasource, helper) {
        ...
        exports.DataSource.prototype = helper.extend({}, datasource.DataSource.prototype, {
            init: function(properties) {
                ...
                datasource.DataSource.prototype.init.apply(this, arguments);
                //TODO: businessObject
                this.type = properties.type || 'View';
                //TODO: name needed?
                this.name = properties.name || '';
                this.id = this.name;
                //TODO: objectName needed?
    ...
    impl_odata3_chart = function(base, helper) {
        var exports = {};
        // =======================================================================
        // chart query
        // =======================================================================
        ...
        exports.ChartQuery.prototype = helper.extend({}, base.ChartQuery.prototype, {
            ...
            execute: function() {
                ...
                var filterConditions = that.filter.getDataForRequest();
                //construct search part of $apply
                var searchExpression = '/sap/opu/odata/SAP/ESH_SEARCH_SRV/SearchQueries/';
                var data = {
                    'd': {
                        'Id': '1',
                        'QueryOptions': {
        ...
        exports.ChartResultSet.prototype = {
            ...
            setJsonFromResponse: function(data) {
                ...
                for (var i = 0; i < data.Values.results.length; ++i) {
                    ...
                    if (isConnectorFacet === true) {
                        //TODO: category
                        var dataSource = that.sina.getDataSourceSyncByBusinessObjectName(item.ValueLow + '/' + item.Type);
                        if (dataSource) {
                            element = {
                                dataSource: dataSource,
                                label: dataSource.getLabel(),
                        ...
                        var group = that.sina.createFilterCondition(data.Id, '=', item.ValueLow, data.Name, item.ValueLowFormatted, item.ValueLowFormatted);
                        element = {
                            label: item.ValueLowFormatted,
                            labelRaw: group,
                            value: item.NumberOfObjects,
                            valueRaw: item.NumberOfObjects
                        };
            ...
            setJsonFromResponseGroupBy: function(data) {
                ...
                for (var j = 0; j < data.d.Facets.results.length; j++) {
                    if (data.d.Facets.results[j].Id === dimension) {
                        dimensionLabel = data.d.Facets.results[j].Name;
                        records = data.d.Facets.results[j].Values.results;
                        break;
                    }
                }
                for (var i = 0; i < records.length; ++i) {
                    var recordJson = records[i];
                    var element = {
                        label: recordJson.ValueLowFormatted,
                        labelRaw: this.sina.createFilterCondition(dimension, '=', recordJson.ValueLow, dimensionLabel, recordJson.ValueLowFormatted, recordJson.ValueLowFormatted),
                        value: recordJson.NumberOfObjects,
                        valueRaw: recordJson.NumberOfObjects
                    };
                    that.elements.push(element);
                }
                return that;
    ...
    impl_odata3_search = function(base, helper) {
        /* eslint camelcase:0 */
        var exports = {};
        // =======================================================================
        // search query
        ...
        exports.SearchResultSet.prototype = {
            ...
            parseRecord: function(record) {
                var that = this;
                var entitySetName = record.DataSourceId + '/' + record.DataSourceType;
                return that.sina.getBusinessObjectMetaDataByBusinessObjectName(entitySetName).then(function(metaData) {
                    var element = that.createEmptyElement(metaData.dataSource);
                    var displayOrder = 0;
                    record.Attributes.results.forEach(function(obj) {
                        element[obj.Id] = that.createAttribute(obj.Id, obj.Value, ++displayOrder, metaData.attributeMap[obj.Id]);
                    });
                    return element;
                });
            },
            //TODO: normalize result in INA and ODATA
            //TODO: WhyFoundSnippet -> Frank
            setJsonFromResponse: function(data) {
                var that = this;
    ...
    impl_odata3_suggestion = function(helper, base, suggestionbase, datasource) {
        /* eslint camelcase:0 */
        var exports = {};
        // =======================================================================
        // suggestion query
        ...
        exports.SuggestionQuery.prototype = helper.extend({}, suggestionbase.SuggestionQuery.prototype, {
            ...
            execute: function() {
                ...
                // do ajax request
                var searchExpression = this.sina.getSystem().servicePath + '/sap/opu/odata/SAP/ESH_SEARCH_SRV/SuggestionsQueries/';
                var data = {
                    'd': {
                        'Id': '1',
                        'SuggestionInput': that.suggestionTerm,
                        'IncludeAttributeSuggestions': true,
                        'IncludeHistorySuggestions': true,
                        'IncludeDataSourceSuggestions': true,
                        'QueryOptions': {
                            'Top': top,
                            'Skip': 0
                        },
        ...
        exports.SuggestionResultSet.prototype = helper.extend({}, suggestionbase.SuggestionQuery.prototype, {
            ...
            setJsonFromResponse: function(data) {
                var that = this;
                return that.sina.getDataSources().then(function(dataSources) {
                    var suggestionsJson = data.d.Suggestions ? data.d.Suggestions.results : [];
                    for (var i = 0; i < suggestionsJson.length; ++i) {
                        var suggestionJson = suggestionsJson[i];
                        var suggestion = {
                            children: [],
                            label: suggestionJson.SearchTermsHighlighted,
                            labelRaw: suggestionJson.SearchTerms,
                            value: 0,
                            valueRaw: 0,
                            dataSource: that.sina.getDataSourceSyncByBusinessObjectName(suggestionJson.FromDataSource + '/View') ? that.sina.getDataSourceSyncByBusinessObjectName(suggestionJson.FromDataSource + '/View') : that.sina.getRootDataSource(),
                            type: base.SuggestionType.OBJECTDATA,
                            attribute: {
                                value: '$$AllAttributes$$'
                            }
        ...
        return exports;
    }(helper, sinabase, suggestionbase, impl_odata3_datasource);
    impl_odata3_perspective = function(sinabase, helper, base, facetbase, querybase) {
        /* eslint camelcase:0 */
        var exports = {};
        // =======================================================================
        // perspective query
        ...
        exports.PerspectiveQuery.prototype = helper.extend({}, querybase.Query.prototype, base.PerspectiveQuery.prototype, {
            ...
            execute: function() {
                ...
                var request = {
                    ...
                    data: data,
                    contentType: 'application/json',
                    url: '/sap/opu/odata/SAP/ESH_SEARCH_SRV/SearchQueries/'
                };
                return this.system.proxy.ajax(request).then(function(data) {
                    perspective = new exports.Perspective({
                        sina: that.sina,
    ...
    impl_odata3_meta = function(helper) {
        /* eslint camelcase:0 */
        var exports = {};
        // =======================================================================
        // class MetaDataService
        ...
        exports.MetaDataService.prototype = {
            ...
            getDataSources: function(properties) {
                var that = this;
                return that._fillInternalBuffer(properties.sina).then(function() {
                    //TODO: rename metadatamap/metadatalist
                    return that.allInOneMap.dataSourcesList;
                });
            },
            getDataSourcesSync: function(properties) {
            ...
            //TODO: parameter as datasource object or string
            getDataSource: function(properties, dataSource) {
                var that = this;
                var entitySetName = dataSource.getName();
                // check input parameters
                ...
                return that._fillInternalBuffer(properties.sina).then(function() {
                    return that.allInOneMap.dataSourceMap[entitySetName + '/' + dataSource.getType()];
                });
            },
            //TODO: remove
            getDataSourceByBusinessObjectName: function(properties, entitySetName) {
            ...
            getDataSourceSync: function(properties, dataSource) {
                ...
                this._fillInternalBufferSync(properties.sina);
                return this.allInOneMap.dataSourceMap[entitySetName + '/' + dataSource.getType()];
            },
            getDataSourceSyncByBusinessObjectName: function(properties, entitySetName) {
                var that = this;
                if (!entitySetName) {
            ...
            getBusinessObjectMetaData: function(properties, dataSource) {
                ...
                return that._fillInternalBuffer(properties.sina).then(function() {
                    return that.allInOneMap.businessObjectMap[entitySetName + '/' + dataSource.getType()];
                });
            },
            getBusinessObjectMetaDataByBusinessObjectName: function(properties, entitySetName) {
                var that = this;
            ...
            getBusinessObjectMetaDataSync: function(properties, dataSource) {
                ...
                this._fillInternalBufferSync(properties.sina);
                return this.allInOneMap.businessObjectMap[entitySetName + '/' + dataSource.getType()];
            },
            getBusinessObjectMetaDataSyncByBusinessObjectName: function(properties, entitySetName) {
                // check input parameters
                if (!entitySetName) {
                ...
                this._fillInternalBufferSync(properties.sina);
                return this.allInOneMap.businessObjectMap[entitySetName + '/' + 'View'];
            },
            _fillInternalBuffer: function(sina) {
                var that = this;
                // check if deferred exists
            ...
            _fireMetaRequest: function(sina, async) {
                var that = this;
                var url = '/sap/opu/odata/sap/ESH_SEARCH_SRV/DataSources?$expand=Attributes/UIAreas&$filter=Type eq \'View\'';
                var request = {
                    async: async === undefined ? true : async,
                    method: 'GET',
                    type: 'GET',
                ...
                var metaRequestDeferred = sina.getSystem().proxy.ajax(request);
                if (request.async) {
                    metaRequestDeferred.done(function(metaJSON) {
                        var allInOneMap = {
                            businessObjectMap: {},
                            // entity map with attributes and entityset name as key
                            businessObjectList: [],
                    ...
                    var results = metaRequestDeferred.responseJSON.d.results;
                    results.forEach(function(elem, index) {
                        var dataSource = sina.createDataSource({
                            label: elem.Name,
                            labelPlural: elem.NamePlural,
            ...
            _parsePresentationUsage: function(usagesInResponse) {
                ...
                usagesInResponse.forEach(function(elem) {
                    switch (elem.Id) {
                        case 'TITLE':
                            usages.push(that.presentationUsageConversionMap.TITLE);
                            break;
                        case 'SUMMARY':
                            usages.push(that.presentationUsageConversionMap.SUMMARY);
                            break;
                        case 'DETAILS':
                            usages.push(that.presentationUsageConversionMap.DETAIL);
                            break;
                        case 'FACTSHEET':
                            usages.push(that.presentationUsageConversionMap.FACTSHEET);
                            break;
                    }
                });
                return usages;
    ...
    impl_odata3_sina = function(helper, sinabase, system, filter, datasource, proxy, datasourcebase, facet, search, suggestion, chart, perspective, meta) {
        /* eslint camelcase:0 */
        var exports = {};
        // =======================================================================
        // sina
        ...
        return exports;
    }(helper, sinabase, impl_odata3_system, impl_odata3_filter, impl_odata3_datasource, proxy, datasource, impl_odata3_facet, impl_odata3_search, impl_odata3_suggestion, impl_odata3_chart, impl_odata3_perspective, impl_odata3_meta);
    sina = function(helper, inaV2Sina, inaV2Proxy, inaV2System, base, baseProxy, odata2Sina, odataSystem, odata3Sina, odata3System) {
        ...
        exports.getSina = function(properties) {
            ...
            if (properties.impl_type === 'INAV2') {
                ...
                if (!properties.system) {
                    properties.system = new odataSystem.System();
                }
            } else if (properties.impl_type === 'ODATA3') {
                if (!properties.system) {
                    properties.system = new odata3System.System();
