...
(function(global) {
    ...
    jQuery.sap.require('sap.ushell.renderers.fiori2.search.controls.SearchResultMap');
    ...
    var SearchMap = sap.ushell.renderers.fiori2.search.controls.SearchResultMap;
    ...
    sap.ui.jsview("sap.ushell.renderers.fiori2.search.container.Search", {
            ...
            var oSegmentedButton = new sap.m.SegmentedButton('ResultViewType', {
                ...
                items: [
                    ...
                    new sap.m.SegmentedButtonItem({
                        ...
                        key: "table"
                    }), (that.getModel() && that.getModel().config.maps ?
                        new sap.m.SegmentedButtonItem({
                            icon: "sap-icon://map",
                    ...
                    var titleLink = new SearchLink({
                        ...
                        press: function() {
                            ...
                            model.eventLogger.logEvent({
                                type: model.eventLogger.ITEM_NAVIGATE,
                                targetUrl: titleUrl
                            });
                        }
                    });
        ...
        assembleSearchResultMap: function() {
            ...
            oSearchResultMap.addEventDelegate({
                onAfterRendering: function() {
                    //to do add this to style sheet!!

                    var h = $(".sapUshellSearchResultMap").parent().parent().css("height");
                    h = parseInt(h, 10);
                    h = 0.8 * h;
                    h = "" + h + "px";
