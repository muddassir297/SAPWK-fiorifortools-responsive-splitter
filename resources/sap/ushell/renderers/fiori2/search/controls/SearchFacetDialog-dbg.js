...
(function() {
    ...
    jQuery.sap.require('sap.ushell.renderers.fiori2.search.SearchFacetDialogHelperCharts');
    ...
    var searchFacetDialogHelperCharts = sap.ushell.renderers.fiori2.search.SearchFacetDialogHelperCharts;
    ...
    sap.m.Dialog.extend('sap.ushell.renderers.fiori2.search.controls.SearchFacetDialog', {
        ...
        resetAllFilters: function(oEvent) {
            ...
            var $checkbox = $(".sapUshellSearchFacetDialogSettingsContainer").find(".sapMCbBg.sapMCbHoverable.sapMCbMark.sapMCbMarkChecked");
        ...
        onDetailPageSelectionChange: function(oEvent) {
            ...
            var oCheckbox = oSettings.getContent()[searchFacetDialogHelper.POS_SHOWONTOP_CHECKBOX];
            var oSelect = oSettings.getContent()[searchFacetDialogHelper.POS_SORTING_SELECT];
