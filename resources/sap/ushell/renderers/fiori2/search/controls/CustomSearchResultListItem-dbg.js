...
(function() {
    ...
    jQuery.sap.require('sap.ushell.renderers.fiori2.search.controls.CustomSearchResultListItemContent');

    sap.ushell.renderers.fiori2.search.controls.SearchResultListItem.extend("sap.ushell.renderers.fiori2.search.controls.CustomSearchResultListItem", {
        // the control API:
        metadata: {
            properties: {
                content: {
