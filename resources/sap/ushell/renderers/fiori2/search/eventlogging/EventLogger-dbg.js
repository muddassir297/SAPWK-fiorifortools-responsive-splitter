...
(function() {
    ...
    // import package
    // =======================================================================
    jQuery.sap.require('sap.ushell.renderers.fiori2.search.eventlogging.SinaLogConsumer');
    var SinaLogConsumer = sap.ushell.renderers.fiori2.search.eventlogging.SinaLogConsumer;
    jQuery.sap.require('sap.ushell.renderers.fiori2.search.eventlogging.HistoryLogConsumer');
    var HistoryLogConsumer = sap.ushell.renderers.fiori2.search.eventlogging.HistoryLogConsumer;
    jQuery.sap.require('sap.ushell.renderers.fiori2.search.eventlogging.UsageAnalyticsConsumer');
    var UsageAnalyticsConsumer = sap.ushell.renderers.fiori2.search.eventlogging.UsageAnalyticsConsumer;
