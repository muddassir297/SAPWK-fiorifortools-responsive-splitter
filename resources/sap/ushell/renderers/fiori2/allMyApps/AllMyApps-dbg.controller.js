...
sap.ui.define([
    ...
    sap.ui.controller("sap.ushell.renderers.fiori2.allMyApps.AllMyApps", {
        ...
        onAfterRendering: function () {
            ...
            setTimeout(function () {
                that._getAllMyAppsManager().loadAppsData(oAllMyAppsModel, that._getPopoverObject());
        ...
        handleMasterListItemPress_toSecondLevel : function (obj) {
            ...
            oView.oDataSourceList.getSelectedItem().focus();
        ...
        _getDataSourcesSelectedPath : function () {
            var oDataSourceList = this.getView().oDataSourceList,
                aSelectedCtxPaths = oDataSourceList.getSelectedContextPaths(),
                sSelectedPath = aSelectedCtxPaths[0];
