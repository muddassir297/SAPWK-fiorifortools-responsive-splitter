 ...
 */
    ...
    AllMyAppsManager.prototype.loadAppsData = function (oModel, oPopoverObject) {
    ...
    AllMyAppsManager.prototype._handleCatalogs = function () {
        ...
        // and jQuery.when calls onDoneLoadingCatalogs only after all the promises are resolved
            .done(function (aCatalogs) {
                jQuery.when.apply(jQuery, this.aPromises).then(this._onDoneLoadingCatalogs(aCatalogs));
            }.bind(this))
    ...
    AllMyAppsManager.prototype._onDoneLoadingCatalogs = function (aCatalogs) {
        var oEventBus = sap.ui.getCore().getEventBus();
