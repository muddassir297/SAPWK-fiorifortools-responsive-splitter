...
sap.ui.define(function() {
    ...
    function ShellModel() {
        ...
        this.addHeaderEndItem = function (aIds, bCurrentState, aStates, bDoNotPropagate) {
            if (aIds.length) {
                this._addUpToThreeItem("headEndItems", aIds, bCurrentState, aStates, bDoNotPropagate);
            }
        };
        ...
        this._addUpToThreeItem = function (sPropertyString, aId, bCurrentState, aStates, bDoNotPropagate) {
            function fnValidation(aItems, aIds, sState) {
