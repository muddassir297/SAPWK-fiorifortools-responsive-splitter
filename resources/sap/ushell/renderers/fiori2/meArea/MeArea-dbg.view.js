...
], function (appType, Button, List, Text, VBox, HBox, Image, Dialog, Popover, OverflowToolbar, ScrollContainer, resources, UserStatusItem, AccessibilityCustomData) {
    "use strict";
    ...
    sap.ui.jsview("sap.ushell.renderers.fiori2.meArea.MeArea", {
        ...
        createIconTabBar: function (oController) {
        	...
        	sap.ui.require(['sap/m/IconTabBar',
        	                ...
        	                'sap/m/IconTabFilter'],
                function (IconTabBar, StandardListItem, IconTabFilter) {

                    oIconTabBar = new IconTabBar('meAreaIconTabBar', {
                        backgroundDesign: sap.m.BackgroundDesign.Transparent,
                        expandable: false,
                        items: [that.createIconTab("recentActivities", true, oController, StandardListItem, IconTabFilter), //Recent activities show timestamp in info property
                                that.createIconTab("frequentActivities", false, oController, StandardListItem, IconTabFilter)] //Frequent activities have no info
        ...
        createIconTab: function (iconTabName, showInfo, oController, StandardListItem, IconTabFilter) {
            ...
            oActivityTemplateFunction = function (sId, oContext) {
                ...
                oLi = new StandardListItem(oLiProperties).addStyleClass('sapUshellMeAreaActivityItem');
