 ...
 */
var PictureViewerItem = Control.extend("sap.ushell.components.factsheet.controls.PictureViewerItem", /** @lends sap.ushell.components.factsheet.controls.PictureViewerItem.prototype */ { metadata : {
