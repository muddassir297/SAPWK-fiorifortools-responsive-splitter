...
"version":"2.0",
"modules":{
	"sap/ushell/components/flp/ActionMode.js":function(){// @copyright@
/**
 * @fileOverview
...
sap.ui.define(['sap/ushell/services/Message', 'sap/ui/base/EventProvider', 'sap/ushell/ui/launchpad/TileState', "sap/ushell/components/flp/launchpad/PagingManager"],
	function(Message, EventProvider, TileState, PagingManager) {
	"use strict";
    ...
    var DashboardManager = EventProvider.extend("sap.ushell.components.flp.launchpad.DashboardManager", {
        ...
        constructor: function (sId, mSettings) {
            ...
            this.bLinkPersonalizationSupported = this.oPageBuilderService.isLinkPersonalizationSupported() && window.location.search.indexOf("new_links_container=true") !== -1;
        ...
        _changeLinksScope: function (oEvent) {
            ...
            if (this.bLinkPersonalizationSupported) {
                ...
                this.oModel.getProperty("/groups").forEach(function (oGroup, index) {
                    that._changeGroupLinksScope(oGroup, bIsTileActionModeActive ? sap.m.GenericTileScope.Actions : sap.m.GenericTileScope.Display);
                });
            }
        },
        ...
        _getConvertTileAction: function (oTile) {
            ...
            return {
                //Convert Tile action
                text: oTile.isLink ? sap.ushell.resources.i18n.getText('ConvertToTile') : sap.ushell.resources.i18n.getText('ConvertToLink'), //TODO: verify strings with Michael
        ...
        _resetGroup: function (sChannelId, sEventId, oData) {
            ...
            this._addRequest($.proxy(function () {
                ...
                oResultPromise.done(this._handleAfterSortable($.proxy(function (sGroupId, oGroup, oResetedGroup) {
                    ...
                    if (oGroupControl.getBindingContext().getObject().links && oGroupControl.getBindingContext().getObject().links.length) {
        ...
        _convertTile: function (sChannelId, sEventId, oSourceTile) {
            var oGroup = oSourceTile.getParent().getBindingContext().getObject(),
                oSourceGroup = oGroup.object,
                ...
                sTileId = oTile.uuid,
                nTileIndex = parseInt(aTileBindingContext[aTileBindingContext.length - 1],10),
                nGroupIndex = oGroup.index,
                oResultPromise;

            var oIndexInfo =  this._adjustIndexForConvert(sType, nTileIndex, oGroup);

            this._addRequest($.proxy(function () {
                try {
                    oResultPromise = this.oPageBuilderService.moveTile(oTile.object, oIndexInfo.tileIndex, oIndexInfo.newTileIndex, oSourceGroup, oSourceGroup, sType === "links" ? "tile" : "link");
                } catch (err) {
                ...
                oResultPromise.done(this._handleAfterSortable($.proxy(function (sTileId, oTargetTile) {
                    ...
                    if (sTilePath) {
                        ...
                        this.oPageBuilderService.getTileView(oTargetTile).done(function (oView) {
                            ...
                            this._changeLinkScope(oView, sType === 'links' ? 'Display' : 'Actions');
                            this.replaceTileViewAfterConvert(oTile, nTileIndex, oTargetTile, oGroup, nGroupIndex, oView, sType);
        ...
        replaceTileViewAfterConvert: function (oTile, nTileIndex, oTargetTile, oGroup, nGroupIndex, oView, sType) {
            ...
            oTile.content = [oView];
            oTile.object = oTargetTile;
            oTile.originalTileId = this.oPageBuilderService.getTileId(oTargetTile);

            //fix the tile position in the model and insert the converted tile\link to the group
            oGroup[sType].splice(nTileIndex, 1);
            oGroup[sType === "tiles" ? "links" : "tiles"].push(oTile);
        ...
        _adjustIndexForConvert: function (sType, nTileIndex, oGroup) {
            var nNewTileIndex;
            if (sType === "tiles") {
                nNewTileIndex = oGroup[sType].length + oGroup["links"].length;
            } else {
                nNewTileIndex = oGroup[sType].length;
                nTileIndex = oGroup["tiles"].length + nTileIndex;
            }
            return {"tileIndex": nTileIndex, "newTileIndex": nNewTileIndex};
        },
         ...
         */
        _moveTile: function (sChannelId, sEventId, oData, sType, sItems) {
            var nNewIndex = oData.toIndex,
                sNewGroupId = oData.toGroupId,
                sTileId = oData.sTileId,
                sSource = oData.source,
                sType = oData.sTileType,
                sItems = sType === 'link' ? 'links' : 'tiles',
            ...
            oTileInfo = this._getTileInfo(aGroups, sTileId, sItems);
            ...
            if (sType === "tile") {
                if (nNewIndex && nNewIndex > oGroupInfo.oNewGroup[sItems].length) {
                    nNewIndex = oGroupInfo.oNewGroup[sItems].length;
                }
            }
            if (oTileInfo.oGroup.groupId === sNewGroupId) {
                if (nNewIndex === null || nNewIndex === undefined) {
                    // moved over group list to same group
                    oTileInfo.oGroup[sItems].splice(oTileInfo.tileIndex, 1);
                    // Tile is appended. Set index accordingly.
                    nNewIndex = oTileInfo.oGroup[sItems].length;
                    // append as last item
                    oTileInfo.oGroup[sItems].push(oTileInfo.oTile);
                } else {
                    nNewIndex = this._adjustTileIndex(nNewIndex, oTileInfo.oTile, oTileInfo.oGroup, sItems);
                    this._moveInArray(oTileInfo.oGroup[sItems], oTileInfo.tileIndex, nNewIndex);
                }

                this.oModel.setProperty("/groups/" + oTileInfo.groupIndex + "/" + sItems, oTileInfo.oGroup[sItems]);
            } else {
                ...
                if (nNewIndex === null || nNewIndex === undefined) {
                    ...
                    nNewIndex = oGroupInfo.oNewGroup[sItems].length;
                    // append as last item
                    oGroupInfo.oNewGroup[sItems].push(oTileInfo.oTile);
                } else {
                    nNewIndex = this._adjustTileIndex(nNewIndex, oTileInfo.oTile, oGroupInfo.oNewGroup, sItems);
                    oGroupInfo.oNewGroup[sItems].splice(nNewIndex, 0, oTileInfo.oTile);
                }
                oGroupInfo.oNewGroup.visibilityModes = sap.ushell.utils.calcVisibilityModes(oGroupInfo.oNewGroup, personalization);
                this.oModel.setProperty("/groups/" + oGroupInfo.newGroupIndex + "/" + sItems, oGroupInfo.oNewGroup[sItems]);
            }
            ...
            // change in backend
            oSourceGroup = this.oModel.getProperty("/groups/" + oTileInfo.groupIndex).object;
            oTargetGroup = this.oModel.getProperty("/groups/" + oGroupInfo.newGroupIndex).object;

            this._addRequest($.proxy(function () {
                try {
                    oResultPromise = this.oPageBuilderService.moveTile(oTileInfo.oTile.object, oTileInfo.tileIndex, nNewIndex, oSourceGroup, oTargetGroup);
                } catch (err) {
                    this._resetGroupsOnFailure("fail_to_move_tile_msg");
                    return;
                }
                ...
                oResultPromise.done(this._handleAfterSortable($.proxy(function (sTileId, oTargetTile) {
                    ...
                    if (sTilePath) {
                        ...
                        this.oPageBuilderService.getTileView(oTargetTile).done(function (oView) {
                            ...
                            if (sItems === 'links') {
                                this._changeLinkScope(oView, sap.m.GenericTileScope.Actions);
                                this._attachLinkPressHandlers(oView);
                                oTileInfo.oTile.content = [oView];
                                this.oModel.setProperty(sTilePath, jQuery.extend({}, oTileInfo.oTile));
                                this.oModel.setProperty("/groups/" + oGroupInfo.newGroupIndex + "/" + sItems, this.oModel.getProperty("/groups/" + oGroupInfo.newGroupIndex + "/" + sItems));
                            } else {
...
//            tileView = srvc.getCatalogTileView(oCatalogTile);
        ...
        _getGroupModel: function (oGroup, bDefault, bLast, oData, fnHandle) {
            ...
            return {
                ...
                links: bHasPendingLinks ? [] : aModelLinks,
                pendingLinks: bHasPendingLinks ? aModelLinks : undefined,
                tiles: aModelTiles,
        ...
        _updateModelWithTilesViews: function (startGroup, startTile) {
            ...
            for (var i = stGroup; i < aGroups.length; i = i + 1) {
                ...
                if (aGroups[i].pendingLinks){
                    this._updateGroupModelWithTilesViews(aGroups[i].pendingLinks, startTile, handledUpdatesIndex, true);
                    if (!this._hasPendingLinks(aGroups[i].pendingLinks)){
                        aGroups[i].links = aGroups[i].pendingLinks;
                        aGroups[i].pendingLinks = undefined;
                    }
                }
            }
        ...
        _getTileModel: function (oTile, isGroupLocked, sTileType, fUpdateModel) {
            ...
            oDfd.done(function (oView) {
                oTileView = oView;
                if (that.bLinkPersonalizationSupported && that.sTileType === "link") { //If the tileType is link and the personalization is supported by the platform, the the link must support personalization
	...
	"sap/ushell/components/flp/launchpad/PagingManager.js":function(){// @copyright@
...
//            }
	...
	"sap/ushell/components/flp/launchpad/appfinder/AppFinder.controller.js":function(){// @copyright@
...
sap.ui.define(['sap/ushell/ui/launchpad/AccessibilityCustomData', 'sap/ushell/ui5service/ShellUIService'],
	...
	"sap/ushell/components/flp/launchpad/appfinder/AppFinder.view.js":function(){// @copyright@
...
sap.ui.define(function () {
	...
	"sap/ushell/components/flp/launchpad/appfinder/Catalog.controller.js":function(){// @copyright@
...
//                oModel.setProperty('/catalogsNoDataText', sap.ushell.resources.i18n.getText('loadingTiles'));
	...
	"sap/ushell/components/flp/launchpad/appfinder/Catalog.view.js":function(){// @copyright@
...
//                categoryAllocateTiles: "{/categoryAllocateTiles}",
	...
	"sap/ushell/components/flp/launchpad/appfinder/EasyAccess.controller.js":function(){// @copyright@
...
sap.ui.define(function() {
	...
	"sap/ushell/components/flp/launchpad/appfinder/GroupListPopover.controller.js":function(){// @copyright@
...
sap.ui.define(function() {
	...
	"sap/ushell/components/flp/launchpad/appfinder/GroupListPopover.view.js":function(){// @copyright@
...
sap.ui.define(function() {
	...
	"sap/ushell/components/flp/launchpad/appfinder/HierarchyApps.controller.js":function(){// @copyright@
...
sap.ui.define(function() {
	...
	"sap/ushell/components/flp/launchpad/appfinder/HierarchyApps.view.js":function(){// @copyright@
...
sap.ui.define(['sap/ushell/ui/appfinder/AppBox','sap/ushell/ui/appfinder/PinButton'],
	...
	"sap/ushell/components/flp/launchpad/appfinder/HierarchyFolders.controller.js":function(){// @copyright@
...
sap.ui.define(function() {
	...
	"sap/ushell/components/flp/launchpad/appfinder/HierarchyFolders.view.js":function(){// @copyright@
...
sap.ui.define(function() {
	...
	"sap/ushell/components/flp/launchpad/dashboard/DashboardContent.controller.js":function(){// @copyright@
...
sap.ui.define([
    ...
    sap.ui.controller("sap.ushell.components.flp.launchpad.dashboard.DashboardContent", {
        ...
        _initializeUIActions: function () {
            var oDashboardUIActionsModule = new DashboardUIActions();
        ...
        _scrollToGroupByName: function (sChannelId, sEventId, oData) {
            ...
            jQuery.each(oGroups, function (nIndex, oGroup) {
                if (oLaunchPageSrv.getGroupTitle(oGroup)  === sGroupName) {
        ...
        _handleDrag: function (event, ui) {
            ...
            if (this.getView().getModel()) {
                this.getView().getModel().setProperty('/draggedTileLinkPersonalizationSupported', bIsLinkPersonalizationSupported);
            }
        },
	...
	"sap/ushell/components/flp/launchpad/dashboard/DashboardContent.view.js":function(){// @copyright@
/**
...
//                    sap.ushell.Container.getRenderer('fiori2').showRightFloatingContainer(false);
	...
	"sap/ushell/components/flp/launchpad/dashboard/DashboardGroupsBox.js":function(){// @copyright@
/**
 ...
 * @private
 */
sap.ui.define (["sap/ui/base/Object", "sap/ushell/ui/launchpad/DashboardGroupsContainer"], function(baseObject, DashboardGroupsContainer) {
	"use strict";
        ...
        _getTileContainerTemplate : function (oController, oModel) {
            var that = this,
                oTilesContainerTemplate = new sap.ushell.ui.launchpad.TileContainer({
                    ...
                    editMode: "{editMode}",
                    showEmptyLinksArea: {
                        parts: ["/tileActionModeActive", "links/length"],
                        formatter: function (tileActionModeActive, numOfLinks) {
                            return tileActionModeActive || !!numOfLinks;
                        }
                    },
	...
	"sap/ushell/components/flp/launchpad/dashboard/DashboardUIActions.js":function(){// @copyright@
/**
...
sap.ui.define(["sap/ui/base/Object"], function(baseObject) {
	...
	"sap/ushell/components/flp/launchpad/group_list/GroupList.controller.js":function(){// @copyright@
...
sap.ui.define(function() {
	...
	"sap/ushell/components/flp/launchpad/group_list/GroupList.view.js":function(){// @copyright@
...
sap.ui.define(['sap/ui/core/IconPool','sap/ushell/ui/launchpad/GroupListItem', 'sap/ushell/override'],
	...
	"sap/ushell/components/flp/settings/FlpSettings.controller.js":function(){// @copyright@
