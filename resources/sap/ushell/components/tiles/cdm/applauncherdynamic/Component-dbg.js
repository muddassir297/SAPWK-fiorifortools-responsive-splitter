        ...
        return UIComponent.extend("sap.ushell.components.tiles.cdm.applauncherdynamic.Component", {
            ...
            createContent : function () {
                ...
                if (oIndicatorDataSource && oIndicatorDataSource.path) {
                    oMergedConfig.serviceUrl = oIndicatorDataSource.path;
                    oMergedConfig.serviceRefreshInterval = oIndicatorDataSource.refresh;
                }
                 ...
                 */
                if (oMergedConfig.serviceUrl && oMergedConfig.serviceUrl.charAt(0) !== "/" && oProperties.dataSource && oProperties.dataSource.uri){
                    ...
                    sServiceUrl += oMergedConfig.serviceUrl;
                    oMergedConfig.serviceUrl = sServiceUrl;
                }
