...
(function () {
    ...
    sap.ui.core.service.Service.extend("sap.ushell.ui5service.UserStatus", /** @lends sap.ushell.ui5service.UserStatus# */ {
        ...
        setEnabled: function (bEnable) {
            ...
            this.getUserStatusSetting().then(function (oUserStatusSetting) {
         ...
         * @public
         */
        getOnlineStatusPopOver: function (sUserStatus) {
        ...
        _showLegalPopup: function () {
            ...
            setTimeout(function () {
                ...
                var signInAsPopOver = that.getOnlineStatusPopOver(sap.ushell.ui.launchpad.UserStatusItem.prototype.STATUS_ENUM.AVAILABLE.status);
                ...
                var saveButton = new sap.m.Button('saveButton', {
                    ...
                    press: function () {
                        that.writeUserStatusSettingToPersonalization({
                ...
                var dialog = new sap.m.Dialog('agreementMessageBox', {
                    ...
                    afterClose: function (e) {
                        that.getUserStatusSetting().then(function (oUserStatusSetting) {
                            if (oUserStatusSetting === undefined || oUserStatusSetting.userStatusEnabled === undefined) {
                                that.writeUserStatusSettingToPersonalization({
         ...
         * @public
         */
        writeUserStatusSettingToPersonalization: function (oUserStatusSetting) {
            var oDeferred,
                oPromise;
