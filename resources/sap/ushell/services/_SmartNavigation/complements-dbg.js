...
( function ( sap ) {
    ...
    sap.ui.define( [], function () {
        if ( !oInstance ) {
            oInstance = Object.create(
                null,
                aFunctionInterfaces.reduce(
                    function ( oPropertyDescriptor, fn ) {
                        oPropertyDescriptor[ fn.name ] = {
                            value: fn,
                            // Make configurable so that it may be stubbed
    ...
    function SemanticObjectHistoryEntry() {
        return {
            ...
            // The sum of the entries should equl the sum of all constituent actions.
            dailyFrequency: [ 0 ]
        };
    }
