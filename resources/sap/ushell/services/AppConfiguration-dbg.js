    ...
    function AppConfiguration() {
        ...
        function applicationOpenedHandler(sChannelId, sEventId, oData) {
            ...
            if (aAppRequestsQueue.length) {
                for (i = 0; i < aAppRequestsQueue.length; i++){
                    aAppRequestsQueue[i]();
                }
        ...
        this.addApplicationSettingsButtons = function (aButtons) {
             ...
             */
            if (oCurrentApplication && oCurrentOpenedApplication && oCurrentApplication.url && oCurrentOpenedApplication.url && oCurrentApplication.url === oCurrentOpenedApplication.url) {
